(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const l={students:[],tasks:{},appointments:[],exams:[],messages:{},coachTodos:{},weekOffset:0,calMonth:new Date().getMonth(),calYear:new Date().getFullYear(),calSelDay:null,activeStuId:null,msgThread:null,workspace:null,studentSpeeds:[],konuHaftaSoru:[]},x={role:null,studentId:null,dbUser:null,coachId:null,childName:null};window.S=l;window.session=x;window._loginMode="email";window.STU_DEFAULT_PASS="Rostrum"+Math.floor(1e3+Math.random()*9e3);window.DAYS_TR=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"];window.MONTHS_TR=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];window.EXAM_DEFS={TYT:["Türkçe","Matematik","Fen","Sosyal"],"AYT-SAY":["Matematik","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Edebiyat","Tarih","Coğrafya"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.EXAM_SORU={TYT:{Türkçe:40,Matematik:40,Fen:20,Sosyal:20},"AYT-SAY":{Matematik:40,Fizik:14,Kimya:13,Biyoloji:13},"AYT-EA":{Matematik:40,Edebiyat:24,Tarih:10,Coğrafya:6},"AYT-SOZ":{Edebiyat:24,Tarih1:10,Tarih2:11,Coğrafya1:6,Coğrafya2:11,Felsefe:12,Din:6}};window.EXAM_KONU_MAP={TYT_Türkçe:["Dil Bilgisi"],TYT_Matematik:["TYT Matematik","Geometri"],TYT_Fen:["TYT Fizik","TYT Kimya","TYT Biyoloji"],TYT_Sosyal:[],"AYT-SAY_Matematik":["AYT Matematik","Geometri"],"AYT-SAY_Fizik":["AYT Fizik"],"AYT-SAY_Kimya":["AYT Kimya"],"AYT-SAY_Biyoloji":["AYT Biyoloji"],"AYT-EA_Matematik":["AYT Matematik","Geometri"],"AYT-EA_Edebiyat":["Dil Bilgisi"]};window.SUBJECT_MAP={TYT:["Türkçe","Matematik","Geometri","Fizik","Kimya","Biyoloji","Tarih","Coğrafya","Felsefe","Din"],"AYT-SAY":["Matematik","Geometri","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Geometri","Edebiyat","Tarih","Coğrafya","Felsefe"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.currentTab="";window._clipboardTask=null;window._editingTaskId=null;window._regRole=null;window._onbRole=null;window._oauthUser=null;const ya="https://imyhenrwmsmyikpollur.supabase.co",xa="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlteWhlbnJ3bXNteWlrcG9sbHVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxNDE3ODYsImV4cCI6MjA5NTcxNzc4Nn0._ySJ5ArD1GYthyitHjdyEjLaUhextIwEqpRoF5ScI34",b=supabase.createClient(ya,xa);window.db=b;function be(){var e;try{localStorage.setItem("ba_ui_"+(((e=x.dbUser)==null?void 0:e.id)||"x"),JSON.stringify({weekOffset:l.weekOffset,activeStuId:l.activeStuId,calMonth:l.calMonth,calYear:l.calYear}))}catch{}}function Je(){be()}function B(e,t){let n=document.getElementById("loadingOverlay");if(document.querySelectorAll(".btn-login, .btn-accent, .btn").forEach(i=>{e?(i.setAttribute("disabled","true"),i.style.opacity="0.6",i.style.pointerEvents="none"):(i.removeAttribute("disabled"),i.style.opacity="",i.style.pointerEvents="")}),e&&!n){n=document.createElement("div"),n.id="loadingOverlay",n.style.cssText="position:fixed;inset:0;background:rgba(15,14,12,.82);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:14px;backdrop-filter:blur(6px)";const i=t||"Yükleniyor...",o=t?'<div style="font-size:36px;animation:overlayPop .3s cubic-bezier(.34,1.56,.64,1) both">🗑️</div>':'<div style="width:38px;height:38px;border:3px solid rgba(255,255,255,.12);border-top-color:var(--accent);border-radius:50%;animation:spin .7s linear infinite"></div>';if(n.innerHTML=`${o}<div style="font-size:14px;font-weight:600;color:#fff;letter-spacing:.2px">${i}</div>`,!document.getElementById("spinStyle")){const s=document.createElement("style");s.id="spinStyle",s.textContent="@keyframes spin{to{transform:rotate(360deg)}}@keyframes overlayPop{from{transform:scale(.6);opacity:0}to{transform:scale(1);opacity:1}}",document.head.appendChild(s)}document.body.appendChild(n)}else!e&&n&&n.remove()}function g(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function K(e){return e instanceof Date?e.toISOString().split("T")[0]:e}function V(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function ve(){return K(new Date)}function Mt(e){return e>=20?"good":e>=12?"mid":"low"}function Xe(e){return{deneme:"📊 Deneme",soru:"📚 Soru",konu:"🎯 Konu",diger:"⭐ Diğer"}[e]||e}function O(e){document.getElementById(e).classList.add("open")}function F(e){document.getElementById(e).classList.remove("open")}function h(e){const t=document.getElementById("toast");t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),2300)}document.addEventListener("click",e=>{e.target.classList.contains("modal-bg")&&e.target.id!=="trialExpiredModal"&&e.target.classList.remove("open")});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".modal-bg.open").forEach(t=>{t.id!=="trialExpiredModal"&&t.classList.remove("open")})});function ee(e,t=0){const n=new Date,a=n.getDay(),o=(a===0?6:a-1)-t,s=new Date(n);return s.setDate(n.getDate()-(o+7)%7+e*7),s.setHours(0,0,0,0),s}function ba(){const e=l.students.find(t=>t.id===l.activeStuId);return(e==null?void 0:e.weekStart)??0}async function Le(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return[...new Uint8Array(t)].map(n=>n.toString(16).padStart(2,"0")).join("")}function Ae(e){return e?e.trim().toLowerCase().replace(/ç/g,"c").replace(/ğ/g,"g").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ş/g,"s").replace(/ü/g,"u").replace(/i̇/g,"i").replace(/ı/g,"i").replace(/i/g,"i").replace(/\s+/g,"").replace(/\u0307/g,""):""}function ha(){if(!("Notification"in window)){console.log("Bu tarayıcı anlık bildirimleri desteklemiyor.");return}Notification.permission!=="granted"&&Notification.permission!=="denied"?Notification.requestPermission().then(e=>{e==="granted"&&h("Bildirim izinleri onaylandı ✓")}):Notification.permission==="granted"?h("Bildirim izinleri zaten açık ✓"):h("Bildirim izinleri tarayıcı ayarlarından engellenmiş.")}window.saveUI=be;window.saveS=Je;window.showLoading=B;window.esc=g;window.fmtDate=K;window.addDays=V;window.todayStr=ve;window.netColor=Mt;window.typeLabel=Xe;window.om=O;window.cm=F;window.showToast=h;window.getWeekStart=ee;window.getStudentWeekStart=ba;window.sha256=Le;window.normalizeUsername=Ae;window.requestNotificationPermission=ha;async function ka(e,t={}){let n=b.from(e).select("*");Object.entries(t).forEach(([o,s])=>{n=n.eq(o,s)});const{data:a,error:i}=await n;return i&&console.error(e,i),a||[]}const wa=4*60*1e3;function At(){return"ra_d_"+(x.coachId||x.studentId||"x")}function dn(){try{localStorage.removeItem(At())}catch{}}function an(){try{localStorage.setItem(At(),JSON.stringify({ts:Date.now(),students:l.students,tasks:l.tasks,appointments:l.appointments,exams:l.exams,messages:l.messages,coachTodos:l.coachTodos,studentSpeeds:l.studentSpeeds,workspace:l.workspace,konuHaftaSoru:l.konuHaftaSoru}))}catch{}}function $a(){try{const e=localStorage.getItem(At());if(!e)return!1;const t=JSON.parse(e);return!t.ts||Date.now()-t.ts>wa?!1:(t.students&&(l.students=t.students),t.tasks&&(l.tasks=t.tasks),t.appointments&&(l.appointments=t.appointments),t.exams&&(l.exams=t.exams),t.messages&&(l.messages=t.messages),t.coachTodos&&(l.coachTodos=t.coachTodos),t.studentSpeeds&&(l.studentSpeeds=t.studentSpeeds),t.workspace&&(l.workspace=t.workspace),t.konuHaftaSoru&&(l.konuHaftaSoru=t.konuHaftaSoru),!0)}catch{return!1}}async function on(){var j;const e=x.coachId,t=x.role,n=t==="coach"||t==="developer"?b.from("workspaces").select("*").eq("coach_id",e).single():Promise.resolve({data:null});let a=b.from("users").select("*").eq("role","student");t==="student"?a=a.eq("id",x.studentId):(t==="coach"||t==="developer")&&(a=a.eq("coach_id",e));const i=a,o=new Date;o.setDate(o.getDate()-60);const s=o.toISOString().split("T")[0],r=new Date;r.setDate(r.getDate()-30);const d=r.toISOString().split("T")[0],c=t==="student"?b.from("tasks").select("*").eq("student_id",x.studentId).gte("date",s):t==="coach"||t==="developer"?b.from("tasks").select("*").eq("coach_id",e).gte("date",s):b.from("tasks").select("*").gte("date",s),p=t==="student"?b.from("appointments").select("*").eq("student_id",x.studentId).gte("date",d):t==="coach"||t==="developer"?b.from("appointments").select("*").eq("coach_id",e).gte("date",d):b.from("appointments").select("*").gte("date",d),m=t==="student"?b.from("exams").select("*").eq("student_id",x.studentId):t==="coach"||t==="developer"?b.from("exams").select("*").eq("coach_id",e):b.from("exams").select("*"),u=t==="student"?b.from("messages").select("*").eq("student_id",x.studentId).order("created_at",{ascending:!1}).limit(200):t==="coach"||t==="developer"?b.from("messages").select("*").eq("coach_id",e).order("created_at",{ascending:!1}).limit(200):b.from("messages").select("*").order("created_at",{ascending:!1}).limit(200),v=t==="coach"||t==="developer"?b.from("coach_todos").select("*").eq("coach_id",e):Promise.resolve({data:[]}),S=t==="student"?b.from("student_speeds").select("*").eq("student_id",x.studentId):t==="coach"||t==="developer"?b.from("student_speeds").select("*").eq("coach_id",e):b.from("student_speeds").select("*"),I=t==="coach"||t==="developer"?b.from("konu_mastery").select("*").eq("coach_id",e):t==="student"?b.from("konu_mastery").select("*").eq("student_id",x.studentId):Promise.resolve({data:[]}),f=t==="coach"||t==="developer"?b.from("konu_tekrar_log").select("*").eq("coach_id",e):t==="student"?b.from("konu_tekrar_log").select("*").eq("student_id",x.studentId):Promise.resolve({data:[]}),[k,w,E,y,z,T,M,_,D,C]=await Promise.all([n,i,c,p,m,u,v,S,I,f]);(t==="coach"||t==="developer")&&(l.workspace=k.data||null),l.students=(w.data||[]).map($=>({id:$.id,name:$.full_name||$.username||"Öğrenci",target:$.target||"",color:$.color||"#4da6ff",progress:$.progress||0,weekStart:$.week_start||0,username:$.username,coachId:$.coach_id,yksArea:$.yks_area||"SAY"})),l.tasks={},(E.data||[]).forEach($=>{const A=`${$.student_id}_${$.date}`;l.tasks[A]||(l.tasks[A]=[]),l.tasks[A].push({_id:$.id,type:$.type,exam:$.exam_type,subject:$.subject,duration:$.duration,note:$.note,done:$.done,student_note:$.student_note||"",student_result:$.student_result||null,student_feedback:$.student_feedback||null,task_items:$.task_items,start_time:$.start_time})}),l.appointments=(y.data||[]).map($=>({id:$.id,studentId:$.student_id,date:$.date,time:$.time,duration:$.duration,type:$.type,note:$.note,meetLink:$.meet_link})),l.exams=(z.data||[]).map($=>({id:$.id,studentId:$.student_id,name:$.name,date:$.date,type:$.exam_type,nets:$.nets||{},examDetails:$.exam_details||{},note:$.student_note,coachComment:$.coach_comment})),l.messages={},(T.data||[]).forEach($=>{l.messages[$.student_id]||(l.messages[$.student_id]=[]),l.messages[$.student_id].push({_id:$.id,from:$.from_role,text:$.text||"",image_url:$.image_url||null,read:$.read,time:new Date($.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})})}),Object.keys(l.messages).forEach($=>l.messages[$].sort((A,L)=>A._id>L._id?1:-1)),l.coachTodos={},(M.data||[]).forEach($=>{l.coachTodos[$.date]||(l.coachTodos[$.date]=[]),l.coachTodos[$.date].push({_id:$.id,task:$.task,note:$.note,done:$.done})}),l.studentSpeeds=_.data||[],l.konuMastery={},(D.data||[]).forEach($=>{l.konuMastery[$.student_id]||(l.konuMastery[$.student_id]={}),l.konuMastery[$.student_id][$.subject]||(l.konuMastery[$.student_id][$.subject]={}),l.konuMastery[$.student_id][$.subject][$.konu]=$}),l.konuTekrarLog={},(C.data||[]).forEach($=>{l.konuTekrarLog[$.student_id]||(l.konuTekrarLog[$.student_id]={}),l.konuTekrarLog[$.student_id][$.subject]||(l.konuTekrarLog[$.student_id][$.subject]={}),l.konuTekrarLog[$.student_id][$.subject][$.konu]||(l.konuTekrarLog[$.student_id][$.subject][$.konu]={}),l.konuTekrarLog[$.student_id][$.subject][$.konu][$.period_start]=$});try{const $=JSON.parse(localStorage.getItem("ba_ui_"+((j=x.dbUser)==null?void 0:j.id))||"{}");$.weekOffset!==void 0&&(l.weekOffset=$.weekOffset),$.activeStuId&&(l.activeStuId=$.activeStuId),$.calMonth!==void 0&&(l.calMonth=$.calMonth,l.calYear=$.calYear)}catch{}}async function cn(){if($a()){on().then(()=>{if(an(),window.currentTab)try{window.switchTab(window.currentTab)}catch{}}).catch(t=>console.error("Arka plan yenileme hatası:",t));return}B(!0);try{await on(),an()}catch(t){console.error("loadAllData error",t)}B(!1)}window.dbQ=ka;window.loadAllData=cn;window.invalidateCache=dn;let Se=!1;function de(e){const t=document.getElementById("loginErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function ot(e){const t=document.getElementById("regErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function pn(e){document.getElementById("loginPanel").style.display=e==="login"?"block":"none",document.getElementById("registerPanel").style.display=e==="register"?"block":"none",document.getElementById("lmtLogin").classList.toggle("active",e==="login"),document.getElementById("lmtRegister").classList.toggle("active",e==="register")}function Ta(e){window._loginMode=e,document.querySelectorAll("#loginTabs .login-tab").forEach((t,n)=>t.classList.toggle("active",n===(e==="email"?0:1))),document.getElementById("loginEmailField").style.display=e==="email"?"block":"none",document.getElementById("loginUserField").style.display=e==="username"?"block":"none"}function Ea(e){window._regRole=e,document.getElementById("rrbCoach").classList.toggle("sel",e==="coach"),document.getElementById("rrbStudent").classList.toggle("sel",e==="student")}function _a(e){window._onbRole=e,document.getElementById("onbRoleCoach").classList.toggle("sel",e==="coach"),document.getElementById("onbRoleStudent").classList.toggle("sel",e==="student")}async function Sa(){if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.protocol==="file:"){un();return}await mn()}async function mn(){Dt(),B(!0);try{const{error:e}=await b.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin+"/app.html",queryParams:{access_type:"offline",prompt:"select_account"}}});e&&(B(!0),console.warn("Google Auth failed:",e),de("Google Girişi Başlatılamadı: "+e.message))}catch(e){B(!1),de("Google Girişi Başlatılamadı: "+e.message)}}function un(){document.getElementById("googleSimulatorModal").style.display="flex"}function Dt(){document.getElementById("googleSimulatorModal").style.display="none"}async function Ia(e){if(Dt(),B(!0),e==="demokoc"){const{data:t,error:n}=await b.from("users").select("*").eq("username","demokoc").maybeSingle();if(n||!t){B(!1),de("Demo koç profili bulunamadı!");return}await De(t)}else if(e==="demoogrenci"){const{data:t,error:n}=await b.from("users").select("*").eq("username","demoogrenci").maybeSingle();if(n||!t){B(!1),de("Demo öğrenci profili bulunamadı!");return}await De(t)}else if(e==="new"){B(!1),document.getElementById("newUserOnboarding").style.display="flex";const t=Math.floor(1e3+Math.random()*9e3),n=`yeni.kullanici${t}@gmail.com`;document.getElementById("onbEmail").textContent=n,document.getElementById("onbName").value=`Yeni Kullanıcı ${t}`,window._oauthUser={id:`mock-google-id-${t}`,email:n,user_metadata:{full_name:`Yeni Kullanıcı ${t}`}}}}async function gn(){var t,n,a;if(window.location.hash.includes("type=recovery")){console.log("[Auth] Recovery session active, skipping checkOAuthSession");return}if(Se)return;Se=!0;let e=null;try{console.log("[Auth] 1/4 getSession...");const{data:{session:i}}=await b.auth.getSession();if(console.log("[Auth] 2/4 session:",((t=i==null?void 0:i.user)==null?void 0:t.email)||"yok"),!(i!=null&&i.user)){Se=!1;return}if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible")){Se=!1;return}B(!0),e=setTimeout(()=>{console.warn("[Auth] timeout — Supabase yanıt vermedi, spinner kapatılıyor"),Se=!1,B(!1)},1e4),console.log("[Auth] 3/4 profil yükleniyor...");const{data:o,error:s}=await b.from("users").select("*").eq("id",i.user.id).maybeSingle();console.log("[Auth] 4/4 profil:",o==null?void 0:o.role,(s==null?void 0:s.message)||""),clearTimeout(e);let r=!1;if(o){if(o.role==="coach"){const{data:d}=await b.from("workspaces").select("*").eq("coach_id",o.id).maybeSingle();(!d||!d.onboarding_done)&&(r=!0)}}else r=!0;o&&!r?await De(o):(B(!1),document.getElementById("newUserOnboarding").style.display="flex",document.getElementById("onbEmail").textContent=i.user.email,document.getElementById("onbName").value=((a=i.user.user_metadata)==null?void 0:a.full_name)||"",window._oauthUser=i.user)}catch(i){clearTimeout(e),Se=!1,B(!1),console.warn("[checkOAuthSession]",i)}}async function za(){const e=document.getElementById("onbName").value.trim();if(!e){document.getElementById("onbErr").textContent="Ad soyad zorunlu",document.getElementById("onbErr").style.display="block";return}if(!window._onbRole){document.getElementById("onbErr").textContent="Hesap türü seçin",document.getElementById("onbErr").style.display="block";return}document.getElementById("onbErr").style.display="none",B(!0);const t=window._oauthUser,n=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""),a={id:t.id,full_name:e,email:t.email,role:window._onbRole,username:n+"_"+Math.random().toString(36).slice(2,6),password_hash:"supabase_managed",color:window._onbRole==="coach"?"#f0a500":"#4da6ff",week_start:0,progress:0,target:""},{data:i,error:o}=await b.from("users").upsert(a).select().single();if(o){B(!1),document.getElementById("onbErr").textContent="Hata: "+o.message,document.getElementById("onbErr").style.display="block";return}document.getElementById("newUserOnboarding").style.display="none",await De(i)}let Q=0;function Ba(e,t){document.getElementById("regBrandColor").value=e,t.parentElement.querySelectorAll("div").forEach(n=>n.style.outline="none"),t.style.outline="3px solid white"}function Ma(){const e=document.getElementById("regErr0");if(e&&(e.style.display="none"),Q===0){if(!window._regRole){e&&(e.textContent="Lütfen bir hesap türü seçin.",e.style.display="block");return}window._regRole==="student"?Q=3:Q=1}else if(Q===1){if(!document.getElementById("regBrandName").value.trim()){alert("Lütfen akademi / koçluk adını girin.");return}Q=2}else Q===2&&(Q=3);Ct(Q)}function Aa(){Q===3?window._regRole==="student"?Q=0:Q=2:Q===2?Q=1:Q===1&&(Q=0),Ct(Q)}function Ct(e){document.getElementById("regWizardStep0").style.display=e===0?"block":"none",document.getElementById("regWizardStepCoach1").style.display=e===1?"block":"none",document.getElementById("regWizardStepCoach2").style.display=e===2?"block":"none",document.getElementById("regWizardStepFinal").style.display=e===3?"block":"none"}async function Da(){const e=document.getElementById("regName").value.trim(),t=document.getElementById("regEmail").value.trim().toLowerCase(),n=document.getElementById("regPass").value;if(!e||!t||!n)return ot("Tüm hesap bilgileri zorunludur");if(n.length<8)return ot("Şifre en az 8 karakter olmalıdır");B(!0);try{let a={full_name:e,role:window._regRole};if(window._regRole==="coach"){const s=document.getElementById("regBrandName").value.trim(),r=document.getElementById("regBrandColor").value||"#f0a500",d=document.getElementById("regPhone").value.trim(),c=[...document.querySelectorAll("#regExamTypesWrap .ob-exam-sel input")].map(u=>u.value),p=c.length>0?c.join(","):"YKS",m=document.getElementById("regStudentCountRange").value||"1-5";a.ob_brand=s,a.ob_color=r,a.ob_phone=d,a.ob_examtypes=p,a.ob_studentcount=m}const{data:i,error:o}=await b.auth.signUp({email:t,password:n,options:{data:a}});if(o)throw o;if(i!=null&&i.user){B(!1),document.getElementById("regName").value="",document.getElementById("regEmail").value="",document.getElementById("regPass").value="",document.getElementById("regBrandName")&&(document.getElementById("regBrandName").value=""),document.getElementById("regPhone")&&(document.getElementById("regPhone").value="");const s=document.getElementById("regSuccess");s.textContent="Kayıt başarılı! E-posta adresinize bir doğrulama bağlantısı gönderildi. Lütfen doğrulama yaptıktan sonra giriş yapın.",s.style.display="block",setTimeout(()=>s.style.display="none",1e4),Q=0,Ct(0),pn("login")}}catch(a){B(!1),ot("Kayıt Hatası: "+a.message)}}async function Ca(){const e=(document.getElementById("loginEmail").value||document.getElementById("loginUser").value||"").trim(),t=document.getElementById("loginPass").value;if(!e||!t)return de("Kullanıcı adı ve şifre zorunlu");B(!0);const n=setTimeout(()=>{B(!1),de("Bağlantı zaman aşımına uğradı. Supabase yanıt vermiyor — lütfen tekrar deneyin.")},15e3);try{let a=e;a.includes("@")?a=a.toLowerCase():a=Ae(e)+"@rostrumakademi.com";const{data:i,error:o}=await b.auth.signInWithPassword({email:a,password:t});if(!o&&(i!=null&&i.user)){const{data:s,error:r}=await b.from("users").select("*").eq("id",i.user.id).maybeSingle();if(r&&console.error("Profile fetch error:",r),s){clearTimeout(n),await De(s);return}return B(!1),de("Hesabınız veritabanında aktif değil.")}try{const s=Ae(e.includes("@")?e.split("@")[0]:e),r=await Le(t),{data:d}=await b.rpc("get_user_by_credentials",{p_username:s,p_password_hash:r}),c=Array.isArray(d)?d[0]:d;if(c){clearTimeout(n),await De(c);return}}catch(s){console.warn("Fallback RPC error:",s)}return B(!1),de(o?"Giriş başarısız: "+o.message:"Kullanıcı adı veya şifre hatalı.")}catch(a){return B(!1),console.error("[doLogin]",a),de("Giriş hatası: "+a.message)}finally{clearTimeout(n)}}async function De(e){var n,a,i,o,s;B(!1);const t=e.role==="coach"||e.role==="developer"?e.id:e.role==="student"||e.role==="parent"?e.coach_id:null;x.role=e.role,x.studentId=e.role==="student"?e.id:null,x.dbUser=e,x.coachId=t,document.getElementById("loginScreen").style.display="none",document.getElementById("appShell").classList.add("visible");try{if(await cn(),(x.role==="coach"||x.role==="developer")&&!l.workspace){console.log("[Auth] Workspace not found, auto-creating from signup metadata...");const{data:{user:p}}=await b.auth.getUser();if(p){const m=((n=p.user_metadata)==null?void 0:n.ob_brand)||"Akademi",u=((a=p.user_metadata)==null?void 0:a.ob_color)||"#f0a500",v=((i=p.user_metadata)==null?void 0:i.ob_phone)||null,S=((o=p.user_metadata)==null?void 0:o.ob_examtypes)||"YKS",I=((s=p.user_metadata)==null?void 0:s.ob_studentcount)||"1-5",f={coach_id:e.id,brand_name:m,brand_color:u,phone:v,exam_types:S,student_count_range:I,onboarding_done:!1},{data:k,error:w}=await b.from("workspaces").upsert(f,{onConflict:"coach_id"}).select().maybeSingle();w?console.error("[finishLogin] Create workspace error:",w):k&&(l.workspace=k)}}if(x.role==="student"&&(l.activeStuId=e.id,x.studentId=e.id,l.students.find(p=>p.id===e.id)||l.students.push({id:e.id,name:e.full_name||e.username||"Öğrenci",target:e.target||"",color:e.color||"#4da6ff",progress:e.progress||0,weekStart:e.week_start||0,username:e.username,coachId:e.coach_id})),x.role==="parent"){const{data:p}=await b.from("users").select("*").eq("parent_id",e.id).single();p&&(l.activeStuId=p.id,x.studentId=p.id,x.childName=p.full_name||p.username)}if(window.setupShell(),document.getElementById("aiChatBubble").style.display="flex",(x.role==="coach"||x.role==="developer")&&(!l.workspace||!l.workspace.onboarding_done)){window.switchTab("home"),window.showOnboarding();return}if(x.role==="student"){const{data:p}=await b.from("student_profiles").select("id").eq("id",x.studentId||e.id).maybeSingle();if(!p){const m=window.location.hash.substring(1),u=m&&document.getElementById("view-"+m)?m:"portal";setTimeout(()=>{window.switchTab(u),window.showStudentWelcome&&window.showStudentWelcome()},100);return}}const r=window.location.hash.substring(1),d={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[x.role]||"portal",c=r&&document.getElementById("view-"+r)?r:d;setTimeout(()=>window.switchTab(c),50)}catch(r){B(!1),console.error("[doLogin] HATA:",r),de("Hata: "+r.message),document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible")}}function La(){window._fcInstance&&(window._fcInstance.destroy(),window._fcInstance=null),window.destroyRealtime&&window.destroyRealtime(),b.auth.signOut().catch(()=>{}),dn(),x.role=null,x.studentId=null,x.dbUser=null,x.coachId=null,x.childName=null,l.workspace=null,document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible"),document.getElementById("aiChatBubble").style.display="none",document.getElementById("aiChatPanel").classList.remove("open"),document.getElementById("loginEmail")&&(document.getElementById("loginEmail").value=""),document.getElementById("loginUser")&&(document.getElementById("loginUser").value=""),document.getElementById("loginPass").value="",window.location.hash=""}function ja(){window.om("forgotPassModal")}async function Pa(){const e=document.getElementById("forgotEmail").value.trim();if(!e)return;const t=document.getElementById("forgotMsg");try{const n=await fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"password_reset",email:e})}),a=await n.json();if(!n.ok)throw new Error(a.error||"Sunucu hatası");t.style.display="block",t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="Sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin."}catch(n){t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Hata: "+(n.message||"Bir sorun oluştu.")}}async function Ra(){const e=document.getElementById("newPasswordInput").value;if(!e||e.length<8){alert("Şifre en az 8 karakter olmalıdır.");return}B(!0);try{const{error:t}=await b.auth.updateUser({password:e});if(t)throw t;const n=await Le(e),{data:{user:a}}=await b.auth.getUser();a&&await b.from("users").update({password_hash:n}).eq("id",a.id),alert("Şifreniz başarıyla güncellendi! Lütfen yeni şifrenizle giriş yapın."),window.cm("resetPasswordModal"),await b.auth.signOut(),window.location.hash="",window.location.reload()}catch(t){alert("Şifre güncellenirken hata oluştu: "+t.message)}finally{B(!1)}}window.loginErr=de;window.regErr=ot;window.setAuthMode=pn;window.setLoginMode=Ta;window.setRegRole=Ea;window.setOnbRole=_a;window.loginWithGoogle=Sa;window.triggerRealGoogleLogin=mn;window.showGoogleSimulator=un;window.closeGoogleSimulator=Dt;window.simOAuthLogin=Ia;window.checkOAuthSession=gn;window.completeOnboarding=za;window.doRegister=Da;window.doLogin=Ca;window.finishLogin=De;window.doLogout=La;window.showForgotPassword=ja;window.sendResetEmail=Pa;window.updateUserPassword=Ra;window.nextRegWizardStep=Ma;window.prevRegWizardStep=Aa;window.setRegBrandColor=Ba;b.auth.onAuthStateChange(async(e,t)=>{var a;if(e==="PASSWORD_RECOVERY"||window.location.hash.includes("type=recovery")){console.log("[Auth] Password recovery flow active, showing resetPasswordModal"),B(!1),window.om("resetPasswordModal");return}if(e==="SIGNED_IN"&&(t!=null&&t.user)){if((a=document.getElementById("appShell"))!=null&&a.classList.contains("visible"))return;await gn()}e==="SIGNED_OUT"&&(Se=!1,B(!1))});function sn(){const e=document.getElementById("loginEmail"),t=document.getElementById("loginUser");e&&t&&(e.addEventListener("input",n=>{t.value=n.target.value}),t.addEventListener("input",n=>{e.value=n.target.value}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",sn):sn();if(new URLSearchParams(window.location.search).get("new_coach")==="1"){const e=sessionStorage.getItem("ra_new_coach_email"),t=sessionStorage.getItem("ra_new_coach_pass");if(e&&t){sessionStorage.removeItem("ra_new_coach_email"),sessionStorage.removeItem("ra_new_coach_pass");const n=()=>{const a=document.getElementById("loginEmail"),i=document.getElementById("loginPass");a&&i&&(a.value=e,i.value=t,setTimeout(()=>window.doLogin&&window.doLogin(),400))};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}function qe(e){if(!e||e<=0)return"0 sa";const t=Math.floor(e/60),n=e%60;return t>0&&n>0?`${t} sa ${n} dk`:t>0?`${t} sa`:`${n} dk`}window.formatMinToHours=qe;function ae(e){return new Promise(t=>{let n=document.getElementById("customConfirmModal");n||(n=document.createElement("div"),n.id="customConfirmModal",n.className="modal-bg",n.style.zIndex="999999",n.innerHTML=`
    ...
    <button onclick="document.getElementById('trialCountdownBanner').remove()" style="background:none;border:none;cursor:pointer;color:rgba(0,0,0,.4);font-size:18px;padding:0 4px;line-height:1">×</button>`,document.body.prepend(t);const n=document.getElementById("appShell");n&&(n.style.marginTop=t.offsetHeight+"px")}window.openSupportChatDirect=ht;window.checkCoachSubscription=Lt;window.showTrialExpiredScreen=ct;window.showTrialCountdownBanner=vn;const St=[{id:"home",lbl:"🏠",name:"Ana Sayfa"},{id:"students",lbl:"👤",name:"Öğrencilerim"},{id:"todolist",lbl:"📅",name:"Ajanda"},{id:"coach-resources",lbl:"📚",name:"Kaynaklarım"},{id:"coach-applications",lbl:"📩",name:"Başvurular"}],fn=[{id:"portal",lbl:"🏠",name:"Ana Sayfa"},{id:"sportal",lbl:"📋",name:"Programım"},{id:"sexams",lbl:"📊",name:"Denemeler"},{id:"smessages",lbl:"💬",name:"Koçuma Yaz"},{id:"suyelik",lbl:"💳",name:"Üyeliğim"},{id:"sprofil",lbl:"🌟",name:"Yolculuğum"}],yn=[{id:"dev-dashboard",lbl:"🖥️",name:"Dev Panel"},{id:"dev-tickets",lbl:"🎫",name:"Destek"}],xn=[{id:"parent-home",lbl:"🏠",name:"Ana Sayfa"},{id:"parent-progress",lbl:"📊",name:"İlerleme"},{id:"parent-messages",lbl:"💬",name:"Koça Yaz"},{id:"parent-ai",lbl:"🤖",name:"AI Asistan"}];function Ha(){var e;(e=document.getElementById("mainSidebar"))==null||e.classList.toggle("open")}function Na(){var e;(e=document.getElementById("tnUserMenu"))==null||e.classList.toggle("open")}function bn(){var e;(e=document.getElementById("tnUserMenu"))==null||e.classList.remove("open")}document.addEventListener("click",e=>{const t=document.getElementById("tnUserWrap");t&&!t.contains(e.target)&&bn()});function Ya(){var c;Lt();const e=x.role==="coach"?St:x.role==="developer"?[...St,...yn]:x.role==="parent"?xn:fn;document.getElementById("sidebarNav").innerHTML=e.map(p=>`
    ...
    <div class="home-bottom-grid">
      ...
      <div class="home-section-card">
        ...
        <div class="hsc-body">
          ...
          ${d.map(T=>{const M=l.students.find(G=>G.id===T.studentId),_=T.time<S,[D,C]=T.time.split(":").map(Number),j=D*60+C,[$,A]=S.split(":").map(Number),L=$*60+A,P=j-L,U=P>=-(T.duration||60)&&P<=15,N=U&&T.meet_link?`<a href="${g(T.meet_link)}" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;background:${P<=0?"var(--red)":"var(--accent)"};color:${P<=0?"white":"#0f0e0c"};font-size:11px;font-weight:800;text-decoration:none;animation:${P<=0?"pulse 1.5s infinite":"none"};white-space:nowrap;flex-shrink:0">${P<=0?"🔴 Ders Sürüyor":"🟡 Derse Gir"}</a>`:"";return`<div class="hsc-appt-row ${_&&!U?"hsc-appt-past":""}">
              ...
              <div style="flex:1;min-width:0">
                ...
                <div class="hsc-appt-meta">${g(T.type)} · ${T.duration} dk${!U&&T.meet_link?` · <a href="${g(T.meet_link)}" target="_blank" style="color:var(--blue);text-decoration:none">${T.meet_link.includes("zoom")?"Zoom":"Meet"} →</a>`:""}</div>
              </div>
              ${N||(_?'<span class="hsc-appt-done">✓</span>':"")}
            </div>`}).join("")}
        </div>
      </div>
    </div>
    ...
    </div>`}catch(a){console.error("[renderHome] HATA:",a),e.innerHTML=`<div style='padding:24px;color:var(--text)'><b>İyi günler 👋</b><p style='color:var(--text-mid);margin-top:6px'>Hata: ${g(a.message)}</p></div>`}}function Qe(){const e=document.getElementById("view-students"),t=ee(0,0),n={};l.students.forEach(s=>{let r=0,d=0,c=0,p=0;for(let m=0;m<7;m++)(l.tasks[`${s.id}_${K(V(t,m))}`]||[]).forEach(v=>{r++,c+=Number(v.duration||0),v.done&&(d++,p+=Number(v.duration||0))});n[s.id]={total:r,done:d,totalMin:c,doneMin:p}});const a=l.students.length,i=l.students.filter(s=>{const r=n[s.id];return r&&r.total>0}).length,o=l.students.filter(s=>{const r=n[s.id];return r&&r.total>0&&r.done===r.total}).length;e.innerHTML=`<div style="max-width:640px;margin:0 auto">
    <!-- Üst başlık -->
  ...
  </div>`}function Ka(){const e=document.getElementById("stuSearchInput").value.trim().toLowerCase(),t=document.getElementById("stuSearchNoResults");let n=0;l.students.forEach(a=>{const i=document.getElementById("sturow_"+a.id);if(i){const o=a.name.toLowerCase().includes(e);i.style.display=o?"flex":"none",o&&n++}}),t&&(t.style.display=e&&n===0?"block":"none")}function kn(e){if(!l.students.find(p=>p.id===e))return;l.activeStuId=e;const t=l.students.find(p=>p.id===l.activeStuId),n=ee(0,t.weekStart||0);let a=0,i=0,o=0;for(let p=0;p<7;p++){const m=l.tasks[`${t.id}_${K(V(n,p))}`]||[];a+=m.length,i+=m.filter(u=>u.done).length,o+=m.reduce((u,v)=>u+Number(v.duration||0),0)}const s=a>0?Math.round(i/a*100):0,r=s>=80?"var(--green)":s>=50?"var(--accent)":"var(--red)",d=document.getElementById("view-student-detail");d.innerHTML=`
    ...
    <div class="card" style="margin-top:16px; border: 1px dashed var(--accent); padding: 18px; border-radius: 14px; background: var(--surface)">
      ...
      <div id="aiCopilotResultArea" style="display:none; margin-top:12px">
    ...
    </div>`,currentTab!=="student-detail"&&ie("student-detail");const c=document.getElementById("tbarTitle");c&&(c.textContent=t.name)}const je=[{stars:0,label:"Başlanmadı",color:"#6b7280",bg:"rgba(107,114,128,.08)",border:"rgba(107,114,128,.2)"},{stars:1,label:"Anlamadım",color:"#ef4444",bg:"rgba(239,68,68,.08)",border:"rgba(239,68,68,.2)"},{stars:2,label:"Temel Zorluk",color:"#f97316",bg:"rgba(249,115,22,.08)",border:"rgba(249,115,22,.2)"},{stars:3,label:"Temel OK",color:"#eab308",bg:"rgba(234,179,8,.08)",border:"rgba(234,179,8,.2)"},{stars:4,label:"Orta Seviye",color:"#84cc16",bg:"rgba(132,204,22,.08)",border:"rgba(132,204,22,.2)"},{stars:5,label:"İleri Seviye",color:"#22c55e",bg:"rgba(34,197,94,.08)",border:"rgba(34,197,94,.2)"},{stars:6,label:"Uzman",color:"#10b981",bg:"rgba(16,185,129,.08)",border:"rgba(16,185,129,.2)"},{stars:7,label:"Tekrar Dışı (TD)",color:"#3b82f6",bg:"rgba(59,130,246,.1)",border:"rgba(59,130,246,.3)"}];function wn(e){const t=new Date(e),n=t.getDate(),a=n<=10?1:n<=20?11:21;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function Oa(e=6){const t=[],n=new Date;let a=new Date(n);for(let i=0;i<e;i++){const o=wn(a);t.find(c=>c.start===o)||t.unshift({start:o,label:Fa(o)});const[s,r,d]=o.split("-").map(Number);if(d===21?a=new Date(s,r-1,11):d===11?a=new Date(s,r-1,1):a=new Date(s,r-2,21),t.length>=e)break}return t.slice(-e)}function Fa(e){const[t,n,a]=e.split("-").map(Number),i=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],o=a===1?10:a===11?20:new Date(t,n,0).getDate();return`${a}-${o} ${i[n-1]}`}const rn={SAY:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","TYT Fizik","AYT Fizik","TYT Kimya","AYT Kimya","TYT Biyoloji","AYT Biyoloji"],EA:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],SOZ:["Dil Bilgisi","TYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],DIL:["Dil Bilgisi","TYT Matematik","Geometri","YDT İngilizce"]};async function Ua(e){const t=l.students.find(f=>f.id===e);if(!t)return;const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${g(t.name)}</button><div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`;const a=x.role==="coach"||x.role==="developer",i=t.yksArea||"SAY",o=rn[i]||rn.SAY;let s=o[0],r="mastery";function d(f,k){var w,E;return((E=(w=l.konuMastery[e])==null?void 0:w[f])==null?void 0:E[k])||null}function c(f,k){var w,E;return((E=(w=l.konuTekrarLog[e])==null?void 0:w[f])==null?void 0:E[k])||{}}async function p(f,k,w,E){const y=d(f,k),z=new Date().toISOString(),T=E||(w>=7?"td":w>0?"active":"not_started"),M={student_id:e,coach_id:x.coachId,subject:f,konu:k,stars:w,status:T,updated_at:z,...T==="active"&&!(y!=null&&y.ka_date)?{ka_date:z}:{},...T==="td"&&!(y!=null&&y.td_date)?{td_date:z}:{},...T==="active"&&(y==null?void 0:y.status)==="td"?{td_date:null}:{}},{data:_,error:D}=await b.from("konu_mastery").upsert(M,{onConflict:"student_id,subject,konu"}).select().single();if(D){h("Hata: "+D.message);return}return l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][k]=_,_}async function m(f,k,w,E){const y=new Date().toISOString(),z={student_id:e,coach_id:x.coachId,subject:f,konu:k,period_start:w,review_count:E,updated_at:y},{data:T,error:M}=await b.from("konu_tekrar_log").upsert(z,{onConflict:"student_id,subject,konu,period_start"}).select().single();if(M){h("Hata: "+M.message);return}return l.konuTekrarLog[e]||(l.konuTekrarLog[e]={}),l.konuTekrarLog[e][f]||(l.konuTekrarLog[e][f]={}),l.konuTekrarLog[e][f][k]||(l.konuTekrarLog[e][f][k]={}),l.konuTekrarLog[e][f][k][w]=T,T}function u(f){const k=We[f]||[],w=k.map((_,D)=>{const C=d(f,_),j=(C==null?void 0:C.stars)||0,$=(C==null?void 0:C.status)||"not_started",A=je[j],L=$==="td",P=D%2===0?"var(--surface)":"var(--surface2)",U=c(f,_),N=Object.values(U).reduce((Z,R)=>Z+(R.review_count||0),0),G=C!=null&&C.last_review_date?new Date(C.last_review_date).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"}):"—",te=a?Array.from({length:7},(Z,R)=>{const H=R+1,Y=H<=j,oe=f.replace(/'/g,"\\'"),fe=_.replace(/'/g,"\\'");return`<span class="km-star${Y?" km-star-on":""}" data-stars="${H}" 
          onclick="window._kmSetStars('${oe}','${fe}',${H})"
          title="${je[H].label}"
        ...
        >${Y?"⭐":"☆"}</span>`}).join(""):Array.from({length:7},(Z,R)=>`<span style="font-size:14px;opacity:${R<j?1:.25}">${R<j?"⭐":"☆"}</span>`).join("");let J="";return L?J='<span style="font-size:9px;font-weight:800;color:#3b82f6;background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.3);border-radius:4px;padding:1px 5px;margin-left:4px">TD</span>':C!=null&&C.ka_date&&(J='<span style="font-size:9px;font-weight:700;color:#10b981;background:rgba(16,185,129,.1);border:1px solid rgba(16,185,129,.2);border-radius:4px;padding:1px 5px;margin-left:4px">KA✓</span>'),`<tr id="${"km_"+btoa(encodeURIComponent(f+"|"+_)).replace(/[^a-zA-Z0-9]/g,"")}" style="background:${A.bg};border-bottom:1px solid ${A.border};transition:background .3s">
      ...
      </tr>`}).join(""),E=k.map(_=>d(f,_)),y=Array(8).fill(0);E.forEach(_=>y[(_==null?void 0:_.stars)||0]++);const z=E.filter(_=>(_==null?void 0:_.status)==="td").length,T=E.filter(_=>(_==null?void 0:_.status)==="active").length;return`<div style="display:flex;gap:12px;flex-wrap:wrap;padding:12px 16px;background:var(--surface2);border-bottom:1px solid var(--border);align-items:center">
      <span style="font-size:11px;color:var(--text-dim)"><b style="color:var(--text)">${k.length}</b> konu</span>
      ...
      <div style="flex:1;height:6px;background:var(--surface3);border-radius:99px;overflow:hidden;min-width:80px;max-width:200px">
        <div style="height:100%;width:${k.length>0?Math.round(z/k.length*100):0}%;background:#3b82f6;border-radius:99px"></div>
      </div>
      <span style="font-size:11px;color:#3b82f6;font-weight:700">${k.length>0?Math.round(z/k.length*100):0}% TD</span>
    ...
    </div>`}function v(f){const k=We[f]||[],w=Oa(6),E=wn(new Date),y=`<tr style="background:var(--surface2)">
      <th style="padding:8px 14px;text-align:left;font-size:10px;font-weight:800;color:var(--text-dim);border-right:1px solid var(--border);position:sticky;left:0;z-index:2;background:var(--surface2);white-space:nowrap;min-width:200px">KONU</th>
      ...
      ${w.map(T=>`<th style="padding:8px 10px;text-align:center;font-size:10px;font-weight:800;color:${T.start===E?"var(--accent)":"var(--text-dim)"};background:${T.start===E?"var(--accent-dim)":"var(--surface2)"};white-space:nowrap;min-width:100px;border-left:1px solid var(--border)">${T.label}</th>`).join("")}
    ...
    </tr>`,z=k.map((T,M)=>{const _=d(f,T),D=(_==null?void 0:_.stars)||0,j=((_==null?void 0:_.status)||"not_started")==="td",$=je[D],A=M%2===0?"var(--surface)":"var(--surface2)",L=c(f,T);let P=0;const U=w.map(G=>{const te=L[G.start],J=(te==null?void 0:te.review_count)||0;P+=J;const X=G.start===E;if(a){const Z=Array.from({length:6},(R,H)=>{const Y=H<J,oe=f.replace(/'/g,"\\'"),fe=T.replace(/'/g,"\\'");return`<span class="kt-box${Y?" kt-box-on":""}"
              onclick="window._ktToggleBox('${oe}','${fe}','${G.start}',${H+1})"
              style="display:inline-block;width:14px;height:14px;border-radius:3px;border:1.5px solid ${Y?$.color:"var(--border2)"};background:${Y?$.bg:"transparent"};cursor:pointer;transition:all .15s;margin:1px"
              title="${H+1}. tekrar"
            ></span>`}).join("");return`<td style="padding:6px 10px;border-left:1px solid var(--border);background:${X?"var(--accent-dim)":A};text-align:center">${Z}</td>`}else{const Z=Array.from({length:6},(R,H)=>{const Y=H<J;return`<span style="display:inline-block;width:12px;height:12px;border-radius:3px;border:1.5px solid ${Y?$.color:"var(--border2)"};background:${Y?$.bg:"transparent"};margin:1px"></span>`}).join("");return`<td style="padding:6px 10px;border-left:1px solid var(--border);background:${X?"var(--accent-dim)":A};text-align:center">${Z}</td>`}}).join(""),N=j?'<span style="font-size:9px;font-weight:800;color:#3b82f6;background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.3);border-radius:4px;padding:1px 5px;margin-left:4px">TD</span>':"";return`<tr style="background:${A}">
      ...
      </tr>`}).join("");return`<div style="overflow-x:auto"><table style="border-collapse:collapse;width:max-content;min-width:100%"><thead>${y}</thead><tbody>${z}</tbody></table></div>`}window._kmSetStars=async function(f,k,w){const E=d(f,k),y=(E==null?void 0:E.status)==="td"&&w<7?"active":null;await p(f,k,w,y);const z="km_"+btoa(encodeURIComponent(f+"|"+k)).replace(/[^a-zA-Z0-9]/g,"");if(document.getElementById(z)){const M=u(f);document.getElementById("khTable").innerHTML=M}h(`${k}: ${je[w].label} ✓`)},window._kmToggleKA=async function(f,k){const w=d(f,k),E=new Date().toISOString(),y=!!(w!=null&&w.ka_date),z={student_id:e,coach_id:x.coachId,subject:f,konu:k,stars:(w==null?void 0:w.stars)||1,status:(w==null?void 0:w.status)||"active",ka_date:y?null:E,updated_at:E},{data:T,error:M}=await b.from("konu_mastery").upsert(z,{onConflict:"student_id,subject,konu"}).select().single();if(M){h("Hata: "+M.message);return}l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][k]=T,document.getElementById("khTable").innerHTML=u(f),h(y?"KA tarihi kaldırıldı":"KA ✓ tamamlandı olarak işaretlendi")},window._kmToggleTD=async function(f,k){const w=d(f,k),E=(w==null?void 0:w.status)==="td",y=E?(w==null?void 0:w.stars)>=7?5:w==null?void 0:w.stars:7;await p(f,k,y,E?"active":"td"),document.getElementById("khTable").innerHTML=r==="mastery"?u(f):v(f),h(E?`${k} tekrar listesine geri döndü`:`${k} → TD ✓`)},window._ktToggleBox=async function(f,k,w,E){const z=c(f,k)[w],M=((z==null?void 0:z.review_count)||0)>=E?E-1:E;if(await m(f,k,w,M),M>0){const _=d(f,k),D=new Date().toISOString(),C={student_id:e,coach_id:x.coachId,subject:f,konu:k,stars:(_==null?void 0:_.stars)||0,status:(_==null?void 0:_.status)||"active",last_review_date:D,review_count:((_==null?void 0:_.review_count)||0)+1,updated_at:D},{data:j}=await b.from("konu_mastery").upsert(C,{onConflict:"student_id,subject,konu"}).select().single();j&&(l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][k]=j)}document.getElementById("khTable").innerHTML=v(f)};function S(){const f=window._khActiveSub||s;document.getElementById("khTable").innerHTML=r==="mastery"?u(f):v(f)}const I=o.map(f=>`<button class="kh-tab" onclick="window._khActiveSub='${f}';document.querySelectorAll('.kh-tab').forEach(b=>{b.style.color='var(--text-mid)';b.style.borderBottom='2px solid transparent';b.style.fontWeight='600'});this.style.color='var(--accent)';this.style.borderBottom='2px solid var(--accent)';this.style.fontWeight='700';window._khRefresh()"
    ...
    </div>`,window._kmSwitchView=function(f){r=f;const k=document.getElementById("kmViewMastery"),w=document.getElementById("kmViewTekrar");f==="mastery"?(k.style.background="var(--accent)",k.style.color="#fff",k.style.fontWeight="700",w.style.background="var(--surface)",w.style.color="var(--text-mid)",w.style.fontWeight="600"):(w.style.background="var(--accent)",w.style.color="#fff",w.style.fontWeight="700",k.style.background="var(--surface)",k.style.color="var(--text-mid)",k.style.fontWeight="600"),window._khRefresh()}}function jt(e){var i,o;l.activeStuId=e;const t=document.getElementById("view-program"),n=((i=l.students.find(s=>s.id===l.activeStuId))==null?void 0:i.name)||"";t.innerHTML=`<button class="back-link" onclick="switchTab('student-detail')">← ${n}</button>`,t.innerHTML+=document.createElement("div").innerHTML,currentTab!=="program"&&ie("program");const a=document.getElementById("tbarTitle");a&&(a.textContent=(((o=l.students.find(s=>s.id===l.activeStuId))==null?void 0:o.name)||"")+" · Program"),W()}function Ga(e){var n;l.activeStuId=e,currentTab!=="exams"&&ie("exams");const t=document.getElementById("tbarTitle");t&&(t.textContent=(((n=l.students.find(a=>a.id===l.activeStuId))==null?void 0:n.name)||"")+" · Denemeler"),Oe()}function qa(e){var n;l.activeStuId=e,currentTab!=="appointments"&&ie("appointments");const t=document.getElementById("tbarTitle");t&&(t.textContent=(((n=l.students.find(a=>a.id===l.activeStuId))==null?void 0:n.name)||"")+" · Randevular"),et()}let ge={};async function Wa(e){const t=l.students.find(a=>a.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&ie("student-detail");const n=document.getElementById("view-student-detail");if(n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${g(t.name)}</button>
    <div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`,!ge[e]){const{data:a}=await b.from("student_books").select("*").eq("student_id",e).order("created_at",{ascending:!0});ge[e]=a||[]}Pt(e)}function Pt(e){const t=l.students.find(p=>p.id===e),n=ge[e]||[],a=document.getElementById("view-student-detail"),i=x.role==="coach"||x.role==="developer",o=n.reduce((p,m)=>p+m.total_tests,0),s=n.reduce((p,m)=>p+m.completed_tests,0),r=o>0?Math.round(s/o*100):0,d=r>=75?"var(--green)":r>=40?"var(--accent)":"var(--red)",c=n.length?n.map(p=>{const m=p.total_tests>0?Math.min(100,Math.round(p.completed_tests/p.total_tests*100)):0,u=m>=75?"var(--green)":m>=40?"var(--accent)":"var(--red)";return`<div style="background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px 16px;margin-bottom:10px">
    ...
    ${c}`}function Va(e){document.getElementById("sbModalTitle").textContent="Kaynak Ekle",document.getElementById("sbId").value="",document.getElementById("sbStuId").value=e,document.getElementById("sbName").value="",document.getElementById("sbTotal").value="0",document.getElementById("sbCompleted").value="0",document.getElementById("sbPctPreview").innerHTML="",O("sbModal")}function Za(e,t){const n=(ge[e]||[]).find(a=>a.id===t);n&&(document.getElementById("sbModalTitle").textContent="Kaynağı Düzenle",document.getElementById("sbId").value=t,document.getElementById("sbStuId").value=e,document.getElementById("sbName").value=n.name,document.getElementById("sbTotal").value=n.total_tests,document.getElementById("sbCompleted").value=n.completed_tests,$n(),O("sbModal"))}function $n(){var o,s;const e=parseInt((o=document.getElementById("sbTotal"))==null?void 0:o.value)||0,t=parseInt((s=document.getElementById("sbCompleted"))==null?void 0:s.value)||0,n=document.getElementById("sbPctPreview");if(!n||!e){n&&(n.innerHTML="");return}const a=Math.min(100,Math.round(t/e*100)),i=a>=75?"var(--green)":a>=40?"var(--accent)":"var(--red)";n.innerHTML=`<div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;height:8px;background:var(--surface3);border-radius:99px;overflow:hidden">
    ...
    </div>`}async function Qa(){var i,o;const e=document.getElementById("pf_name").value.trim(),t=document.getElementById("pf_pass").value,n=(o=(i=document.getElementById("pf_brand"))==null?void 0:i.value)==null?void 0:o.trim();if(!e)return h("Ad boş olamaz!");const a={full_name:e};t&&(a.password_hash=await Le(t)),await b.from("users").update(a).eq("id",x.dbUser.id),n&&(x.role==="coach"||x.role==="developer")&&(await b.from("workspaces").update({brand_name:n}).eq("coach_id",x.coachId),l.workspace={...l.workspace||{},brand_name:n},document.querySelector(".sb-logo-text").textContent=n),x.dbUser={...x.dbUser,full_name:e},document.getElementById("sbName").textContent=e,h("Profil kaydedildi ✓")}function En(){var n;const e=document.getElementById("view-settings"),t=document.documentElement.getAttribute("data-theme")==="dark";e.innerHTML=`
    ...
    </div>`}function ei(){const e=document.getElementById("geminiApiKeyInput").value.trim();e?(localStorage.setItem("gemini_api_key",e),h("API Anahtarı kaydedildi ✓")):(localStorage.removeItem("gemini_api_key"),h("API Anahtarı kaldırıldı."))}let ze="";function W(){const e=document.getElementById("view-program"),t=l.students.find(d=>d.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=ee(l.weekOffset,n),i=V(a,6),o=ve(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let d=0;d<7;d++){const c=V(a,d),p=K(c),m=p===o,u=`${l.activeStuId}_${p}`,v=l.tasks[u]||[],S=v.reduce((y,z)=>y+Number(z.duration),0),I=v.reduce((y,z)=>y+(z.done?Number(z.duration):0),0),f=DAYS_TR[(n+d)%7],k=[...v];s==="hourly"&&k.sort((y,z)=>y.start_time&&!z.start_time?-1:!y.start_time&&z.start_time?1:y.start_time&&z.start_time?y.start_time.localeCompare(z.start_time):0);const w=k.map(y=>{const z=v.indexOf(y),T=y.start_time?`<div class="tc-time-badge">🕒 ${y.start_time}</div>`:"";return`
    ...
    <div class="week-grid">${r}</div>`}function ti(e){l.activeStuId=e||null,Je(),W()}function ni(e){l.weekOffset+=e,Je(),W()}function ai(){l.weekOffset=0,Je(),W()}function ii(e){localStorage.setItem("ra_program_mode",e),x.role==="student"?_e():W()}window.setProgramMode=ii;(()=>{const e=document.createElement("style");e.textContent=`
    .tc-time-badge {
      font-size: 11px;
      font-weight: 800;
      color: var(--accent);
  ...
  `,document.head.appendChild(e)})();let re=[];function oi(){if(!l.activeStuId)return h("Önce öğrenci seçin");const e=l.students.find(i=>i.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=ee(l.weekOffset,t);re=[];let a="";for(let i=0;i<7;i++){const o=V(n,i),s=K(o);DAYS_TR[(t+i)%7];const r=(l.tasks[`${l.activeStuId}_${s}`]||[]).length>0,d=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(t+i)%7];a+=`<button class="day-sel-btn" id="dsbtn_${i}" data-ds="${s}" onclick="toggleDaySel(${i},'${s}')">
    ...
    <div onclick="selectBook(${p})" style="padding:10px 14px;cursor:pointer;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;transition:background .15s"
    ...
    </div>`).join("")}function fi(){const e=document.getElementById("tmBookSearch").value;if(e.length===0){document.getElementById("tmBookList").style.display="none";return}ft(e)}function yi(e){q=Ue[e],document.getElementById("tmBookVal").value=q.name,document.getElementById("tmBookSearch").value=q.name,document.getElementById("tmBookList").style.display="none",Ht(),document.getElementById("tmTestWrap").style.display=""}function Ht(){if(!q)return;const e=document.getElementById("tmTestList"),t=q.resource_type==="playlist",n=q.name||"";e.innerHTML=q.testler.map((a,i)=>{const o=a.label||a,s=o.trim()===""||o.trim()===n.trim()?`Ders ${i+1}`:o,r=a.soru||0,d=a.url||"";a.topic;const c=ua(o),p=c==="done"?"ti-status-done":c==="pending"?"ti-status-pending":"",m=c==="done"?'<span class="ti-badge ti-badge-done">✓ Tamamlandı</span>':c==="pending"?'<span class="ti-badge ti-badge-pending">⏳ Atandı</span>':"";return t?`<label class="${p}" style="display:flex;align-items:center;gap:8px;padding:8px 10px;cursor:pointer;transition:background .1s;border-bottom:1px solid var(--border)"
        onmouseover="this.style.background='var(--surface3)'" onmouseout="this.style.background=''">
      ...
      </label>`}).join(""),Ke()}function xi(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!0),Ke()}function bi(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!1),Ke()}function Ke(){if(!q)return;const e=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")],t=document.getElementById("tmTestSummary"),n=document.getElementById("tmTestSummaryText"),a=document.getElementById("tmSuggestedDuration"),i=document.getElementById("tmSpeedRow"),o=q.resource_type==="playlist";if(e.length===0){t.style.display="none";return}let s=0,r=0;e.forEach(m=>{const u=parseInt(m.value),v=q.testler[u];o?r+=(v==null?void 0:v.soru)||0:s+=(v==null?void 0:v.soru)||0});const d=document.querySelector("[data-mspeed].speed-active"),c=d?parseFloat(d.dataset.mspeed):1;let p=0;if(o)p=r>0?Math.ceil(r/c):0,n.textContent=`${e.length} video · ${r} dk`,i&&(i.style.display="");else{const m=document.getElementById("tmExam").value,u=document.getElementById("tmSubjectSel").value||"",v=`${l.activeStuId}_${m}_${u}`,S=pt[v]||180;p=s>0?Math.ceil(s*S/60):0,n.textContent=`${e.length} test · ${s} soru${p>0?" · Önerilen: "+p+" dk":""}`,i&&(i.style.display="none")}a.style.display=p>0?"":"none",st=p,a.setAttribute("data-dur",p),t.style.display="",p>0&&(document.getElementById("tmDuration").value=p)}function hi(e){document.querySelectorAll("[data-mspeed]").forEach(t=>{const n=t.dataset.mspeed===e;t.classList.toggle("speed-active",n),t.style.borderColor=n?"var(--accent)":"var(--border)",t.style.background=n?"var(--accent-dim)":"var(--surface2)",t.style.color=n?"var(--accent)":"var(--text-mid)"}),Ke()}let st=0;function ki(){st>0&&(document.getElementById("tmDuration").value=st,h("Süre uygulandı: "+st+" dk"))}let pt={};async function zn(){if(!l.activeStuId)return;const{data:e}=await b.from("student_speeds").select("*").eq("student_id",l.activeStuId);pt={},(e||[]).forEach(t=>{const n=`${t.student_id}_${t.exam_type}_${t.subject}`;pt[n]=t.secs_per_question})}async function Bn(e,t,n,a){const{data:i}=await b.from("student_speeds").select("id").eq("student_id",e).eq("exam_type",t).eq("subject",n).single();i?await b.from("student_speeds").update({secs_per_question:a,updated_at:new Date().toISOString()}).eq("id",i.id):await b.from("student_speeds").insert({student_id:e,coach_id:x.coachId,exam_type:t,subject:n,secs_per_question:a}),pt[`${e}_${t}_${n}`]=a,h("Hız kaydedildi ✓")}document.getElementById("tmType").addEventListener("change",Rt);let wt=!1;async function wi(){var n;if(wt)return;wt=!0;const e=document.querySelector('#taskModal button[onclick*="saveTask"]'),t=e?e.textContent:"Programa Ekle";e&&(e.disabled=!0,e.textContent="Kaydediliyor...");try{const a=document.getElementById("tmType").value,i=document.getElementById("tmSubjectSel"),o=document.getElementById("tmSubjectFree"),s=document.getElementById("tmExam").value,r=parseInt(document.getElementById("tmDuration").value)||60,d=document.getElementById("tmStartTime").value||null,c=document.getElementById("tmNote").value.trim();if((n=document.getElementById("tmNewResourceToggle"))==null?void 0:n.checked){const w=document.getElementById("tmManualKaynak").value.trim();if(!w)return h("Kaynak adı girin!");const E=i.style.display!=="none"?i.value:o.value.trim(),y=E?`${E} - ${w}`:w,z=ue.map(C=>({label:C,url:"",soru:0}));let T=c;ue.length>0&&(T=`${ue.length} test: ${ue.slice(0,3).join(", ")}${ue.length>3?` +${ue.length-3} daha`:""}`);const M={student_id:l.activeStuId,coach_id:x.coachId,date:ze,type:a,exam_type:s,subject:y,duration:r,note:T,done:!1,task_items:z.length>0?z:null,start_time:d};B(!0);const{error:_}=await b.from("tasks").insert(M);if(B(!1),_)return h("Hata: "+_.message);const D=`${l.activeStuId}_${ze}`;l.tasks[D]||(l.tasks[D]=[]),l.tasks[D].push({type:a,exam:s,subject:y,duration:r,note:T,done:!1,task_items:M.task_items,start_time:d}),F("taskModal"),W(),h("Görev eklendi ✓");return}const m=document.getElementById("tmBookVal").value,u=(q==null?void 0:q.resource_type)==="playlist";let v="";if((a==="soru"||a==="konu")&&m){const w=i.style.display!=="none"?i.value:"";v=w?`${w} - ${m}`:`${m}`}else v=(i.style.display!=="none"?i.value:o.value).trim();if(!v)return h("Ders adı girin!");const S=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")];let I=c,f=[];if(S.length>0&&q){const w=S.map(E=>{const y=q.testler[parseInt(E.value)];return(y==null?void 0:y.label)||y||""});if(f=S.map(E=>{const y=q.testler[parseInt(E.value)];return{label:(y==null?void 0:y.label)||y||"",url:(y==null?void 0:y.url)||"",soru:(y==null?void 0:y.soru)||0}}),u){const E=y=>y.length>14?y.slice(0,13)+"…":y;I=`${w.length} video: ${w.slice(0,5).map(E).join(", ")}${w.length>5?` +${w.length-5}`:""}`}else{const E=y=>y.length>14?y.slice(0,13)+"…":y;I=`${w.length} test: ${w.slice(0,5).map(E).join(", ")}${w.length>5?` +${w.length-5}`:""}`}}const k={student_id:l.activeStuId,coach_id:x.coachId,date:ze,type:a,exam_type:s,subject:v,duration:r,note:I,done:!1,task_items:f.length>0?f:null,start_time:d};if(_editingTaskId){B(!0);const{error:w}=await b.from("tasks").update({type:k.type,exam_type:k.exam_type,subject:k.subject,duration:k.duration,note:k.note,task_items:k.task_items,start_time:k.start_time}).eq("id",_editingTaskId);if(B(!1),w)return h("Hata: "+w.message);const E=`${l.activeStuId}_${ze}`;if(l.tasks[E]){const y=l.tasks[E].findIndex(z=>z._id===_editingTaskId);y!==-1&&(l.tasks[E][y]={_id:_editingTaskId,type:k.type,exam:k.exam_type,subject:k.subject,duration:k.duration,note:k.note,done:l.tasks[E][y].done,student_note:l.tasks[E][y].student_note||"",task_items:k.task_items,start_time:k.start_time})}F("taskModal"),W(),h("Görev güncellendi ✓"),_editingTaskId=null}else{const{data:w,error:E}=await b.from("tasks").insert(k).select().single();if(E)return h("Hata: "+E.message);const y=`${l.activeStuId}_${ze}`;l.tasks[y]||(l.tasks[y]=[]),l.tasks[y].push({_id:w.id,type:w.type,exam:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,done:!1,student_note:"",task_items:w.task_items||null,start_time:w.start_time}),F("taskModal"),W(),h("Görev eklendi ✓")}}finally{wt=!1,e&&(e.disabled=!1,e.textContent=t)}}async function $i(e,t){var o;const n=`${l.activeStuId}_${e}`,a=(o=l.tasks[n])==null?void 0:o[t];if(!a)return;const i=!a.done;await b.from("tasks").update({done:i}).eq("id",a._id),a.done=i,W()}let rt=null;function Nt(){rt&&(rt.remove(),rt=null)}document.addEventListener("click",Nt);function Ti(e,t,n){Nt();const a=n.getBoundingClientRect(),i=document.createElement("div");i.className="tc-dropdown",i.innerHTML=`
...
`)],{type:"text/calendar;charset=utf-8"}),a=URL.createObjectURL(n),i=document.createElement("a");i.href=a,i.download="rostrum-ajanda.ics",i.click(),URL.revokeObjectURL(a),h("Ajanda indirildi ✓")}function Dn(e,t){t.stopPropagation();const n=document.getElementById("apptDetailPopup");if(n){const v=n.dataset.id;if(n.remove(),v===e)return}const a=l.appointments.find(v=>v.id===e);if(!a)return;const i=l.students.find(v=>v.id===a.studentId),o=An(a.type),s=document.createElement("div");s.id="apptDetailPopup",s.dataset.id=e;const r=window.innerWidth,d=window.innerHeight,c=264;let p=Math.min(t.clientX+12,r-c-12),m=Math.min(t.clientY+12,d-220);s.style.cssText=`position:fixed;left:${p}px;top:${m}px;z-index:600;width:${c}px;background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:14px 16px;box-shadow:0 8px 32px rgba(0,0,0,.18);animation:viewIn .15s ease`;const u=a.meetLink||a.meet_link;s.innerHTML=`
    ...
    <div style="display:flex;gap:6px;flex-wrap:wrap">
      ...
      <a href="${zi(a)}" target="_blank" style="font-size:11px;font-weight:700;color:var(--green);background:var(--green-dim);padding:4px 10px;border-radius:99px;text-decoration:none">📅 GCal</a>
    ...
    </div>`,document.body.appendChild(s),setTimeout(()=>{document.addEventListener("click",function v(S){s.contains(S.target)||(s.remove(),document.removeEventListener("click",v))})},50)}async function Li(e,t){e.preventDefault();const n=window._draggingApptId;if(!n)return;window._draggingApptId=null;const a=e.currentTarget,i=a.getBoundingClientRect(),o=a.closest("[data-tl-scroll]"),s=o?o.scrollTop:0,d=(e.clientY-i.top+s)/Ii*60+ln*60,c=Math.max(ln,Math.min(Si-1,Math.floor(d/60))),p=Math.round(d%60/15)*15,m=p>=60?0:p,u=`${String(c).padStart(2,"0")}:${String(m).padStart(2,"0")}`,{error:v}=await b.from("appointments").update({date:t,time:u}).eq("id",n);if(v){h("Hata: "+v.message);return}const S=l.appointments.find(I=>I.id===n);S&&(S.date=t,S.time=u),he(),h("Randevu taşındı ✓")}function Cn(){he()}function he(){const e=document.getElementById("view-todolist");if(!e)return;if(!document.getElementById("fc-styles")){const r=document.createElement("style");r.id="fc-styles",r.textContent=`
      .fc {
...
Giriş yaptıktan sonra programını görebileceksin!`);a.innerHTML=`<div class="modal" style="max-width:480px">
  ...
  </div>`,window._pendingInvite={name:e,username:t,pass:n,loginUrl:o},O("inviteModal")}async function Ni(){var s,r;const e=(s=document.getElementById("inviteEmailInput"))==null?void 0:s.value.trim(),t=document.getElementById("inviteEmailMsg");if(!e||!e.includes("@")){t&&(t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Geçerli bir e-posta girin.");return}if(!window._pendingInvite)return;const{name:n,username:a,pass:i,loginUrl:o}=window._pendingInvite;t&&(t.style.display="block",t.style.background="var(--surface2)",t.style.color="var(--text-mid)",t.textContent="Gönderiliyor...");try{const d=await fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"student_welcome",to:e,student_name:n,username:a,password:i,login_url:o,coach_name:((r=l.workspace)==null?void 0:r.brand_name)||""})}),c=await d.json();if(d.ok)t&&(t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="✓ Mail gönderildi!");else throw new Error(c.error||"Sunucu hatası")}catch(d){t&&(t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="✗ "+d.message)}}window.sendInviteEmail=Ni;function Yi(e,t,n){const a=`Giriş adresi: ${n}
Kullanıcı adı: ${e}
Şifre: ${t}`;navigator.clipboard.writeText(a).then(()=>h("Kopyalandı ✓")).catch(()=>{const i=document.createElement("textarea");i.value=a,document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove(),h("Kopyalandı ✓")})}async function Ki(e){var a;if(!await ae("Bu öğrenciyi silmek istediğinizden emin misiniz?"))return;const t=document.getElementById(`sturow_${e}`);t&&(t.style.transition="all 0.3s ease",t.style.opacity="0",t.style.transform="translateX(30px)",t.innerHTML='<div style="color:var(--red); font-weight:700; font-size:13px; display:flex; align-items:center; gap:6px">🗑️ Siliniyor...</div>'),await new Promise(i=>setTimeout(i,300));const{error:n}=await b.from("users").delete().eq("id",e);if(n)return h("Hata: "+n.message);l.students=l.students.filter(i=>i.id!==e),l.activeStuId===e&&(l.activeStuId=((a=l.students[0])==null?void 0:a.id)||null),be(),jn(),h("Silindi")}function et(){var t;const e=document.getElementById("view-appointments");e.innerHTML=`
    ...
    </div>`}).join("")}function Ui(e){const t=e?l.appointments.find(n=>n.id===e):null;document.getElementById("amTitle").textContent=t?"Randevuyu Düzenle":"Yeni Randevu",document.getElementById("amId").value=e||"",document.getElementById("amStudent").innerHTML=l.students.map(n=>`<option value="${n.id}" ${(t==null?void 0:t.studentId)===n.id?"selected":""}>${g(n.name)}</option>`).join(""),document.getElementById("amDate").value=t?t.date:K(new Date),document.getElementById("amTime").value=t?t.time:"14:00",document.getElementById("amDuration").value=t?t.duration:"45",document.getElementById("amType").value=t?t.type:"Haftalık Değerlendirme",document.getElementById("amNote").value=(t==null?void 0:t.note)||"",document.getElementById("amMeetLink").value=(t==null?void 0:t.meet_link)||"",O("apptModal")}async function Gi(){var s;const e=document.getElementById("amStudent").value,t=document.getElementById("amDate").value,n=document.getElementById("amTime").value;if(!e||!t||!n)return h("Tüm alanları doldurun!");const a=document.getElementById("amMeetLink").value.trim();if(a&&!a.startsWith("https://"))return h("Toplantı linki https:// ile başlamalı");if(a&&!/zoom\.us|meet\.google|teams\.microsoft|webex\.com/.test(a))return h("Geçersiz link — Zoom, Meet, Teams veya Webex linki girin");const i=document.getElementById("amId").value,o={student_id:e,coach_id:x.coachId,date:t,time:n,duration:parseInt(document.getElementById("amDuration").value),type:document.getElementById("amType").value,note:document.getElementById("amNote").value.trim(),meet_link:a};if(i){await b.from("appointments").update(o).eq("id",i);const r=l.appointments.find(d=>d.id===i);r&&Object.assign(r,{studentId:e,date:t,time:n,duration:o.duration,type:o.type,note:o.note}),h("Güncellendi ✓")}else{const{data:r,error:d}=await b.from("appointments").insert(o).select().single();if(d)return h("Hata: "+d.message);l.appointments.push({id:r.id,studentId:r.student_id,date:r.date,time:r.time,duration:r.duration,type:r.type,note:r.note}),h("Randevu eklendi ✓")}F("apptModal"),currentTab==="todolist"?he():(s=document.getElementById("view-appointments"))!=null&&s.classList.contains("active")&&et()}async function qi(e){if(!await ae("Bu randevuyu silmek istediğinizden emin misiniz?"))return;const t=document.querySelector(`[data-appt-id="${e}"]`);if(t){t.style.transition="all 0.3s ease",t.style.opacity="0",t.style.transform="translateX(30px)";const n=t.querySelector(".appt-name");n&&(n.innerHTML='<span style="color:var(--red); font-weight:700">🗑️ Siliniyor...</span>')}await new Promise(n=>setTimeout(n,300)),await b.from("appointments").delete().eq("id",e),l.appointments=l.appointments.filter(n=>n.id!==e),et(),h("Silindi")}function Wi(){const e=ve(),t=l.appointments.filter(r=>r.date>=e).sort((r,d)=>r.date.localeCompare(d.date));if(!t.length)return h("Yaklaşan randevu bulunamadı.");const n=r=>String(r).padStart(2,"0"),a=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//Rostrum Akademi//TR","CALSCALE:GREGORIAN","METHOD:PUBLISH","BEGIN:VTIMEZONE","TZID:Europe/Istanbul","BEGIN:STANDARD","TZOFFSETFROM:+0300","TZOFFSETTO:+0300","TZNAME:TRT","DTSTART:19700101T000000","END:STANDARD","END:VTIMEZONE"];t.forEach(r=>{const d=l.students.find(k=>k.id===r.studentId),[c,p,m]=r.date.split("-"),[u,v]=(r.time||"09:00").split(":"),S=`${c}${p}${m}T${u}${v}00`,I=new Date(Number(c),Number(p)-1,Number(m),Number(u),Number(v)+(r.duration||45)),f=`${I.getFullYear()}${n(I.getMonth()+1)}${n(I.getDate())}T${n(I.getHours())}${n(I.getMinutes())}00`;a.push("BEGIN:VEVENT"),a.push(`UID:ra-appt-${r.id}@rostrumakademi.com`),a.push(`DTSTART;TZID=Europe/Istanbul:${S}`),a.push(`DTEND;TZID=Europe/Istanbul:${f}`),a.push(`SUMMARY:${r.type}${d?" — "+d.name:""}`),r.note&&a.push(`DESCRIPTION:${r.note.replace(/[\r\n]+/g,"\\n")}`),r.meet_link&&a.push(`URL:${r.meet_link}`),a.push("END:VEVENT")}),a.push("END:VCALENDAR");const i=new Blob([a.join(`\r
`)],{type:"text/calendar;charset=utf-8"}),o=URL.createObjectURL(i),s=document.createElement("a");s.href=o,s.download="rostrum-randevular.ics",s.click(),setTimeout(()=>URL.revokeObjectURL(o),1e3),h(`${t.length} randevu takvim dosyasına aktarıldı ✓`)}function mt(e){return 100+(Number(e.Türkçe||0)+Number(e.Matematik||0)+Number(e.Fen||0)+Number(e.Sosyal||0))*(400/120)}function Rn(e,t){const n=a=>Number(t[a]||0);return e==="AYT-SAY"?100+(n("Matematik")+n("Fizik")+n("Kimya")+n("Biyoloji"))*5:e==="AYT-EA"?100+(n("Matematik")+n("Edebiyat")+n("Tarih")+n("Coğrafya"))*5:e==="AYT-SOZ"?100+(n("Edebiyat")+n("Tarih1")+n("Tarih2")+n("Coğrafya1")+n("Coğrafya2")+n("Felsefe")+n("Din"))*5:null}const Hn={"AYT-SAY":"SAY","AYT-EA":"EA","AYT-SOZ":"SÖZ"},ut={TYT:"#3B82F6",SAY:"#8B5CF6",EA:"#10B981",SÖZ:"#F59E0B"};function Nn(e,t){const{type:n,nets:a}=e;if(n==="TYT"){const d=mt(a),c=ut.TYT;return`<div style="margin-top:10px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
    ...
    </div>`}const i=Hn[n];if(!i)return"";const o=ut[i]||"#64748B",s=Rn(n,a),r=t.filter(d=>d.type==="TYT"&&d.date<=e.date).sort((d,c)=>c.date.localeCompare(d.date))[0];if(r){const d=mt(r.nets),c=d*.4+s*.6;return`<div style="margin-top:10px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">
    ...
    </div>`;return}const a=Hn[t],i=ut[a]||"#64748B",o=Rn(t,n);if(o===null){e.innerHTML="";return}const s=(c=document.getElementById("emStudent"))==null?void 0:c.value,r=s?[...l.exams].filter(p=>p.studentId===s&&p.type==="TYT").sort((p,m)=>m.date.localeCompare(p.date))[0]:null;if(r){const p=mt(r.nets),m=p*.4+o*.6;e.innerHTML=`<div style="background:${i}12;border:1px solid ${i}35;border-radius:10px;padding:10px 14px">
  ...
  </div>`,S=o.map(R=>{var nn;const H=Number(((nn=a.nets)==null?void 0:nn[R])||0),Y=(EXAM_SORU[a.type]||{})[R]||40,oe=Math.min(100,Math.max(0,H/Y*100)),fe=H>=Y*.6?"#3ecf8e":H>=Y*.35?"#f0a500":"#ef4444";return`<div style="margin-bottom:11px">
      <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:4px">
        <span style="font-size:12px;font-weight:600;color:var(--text)">${g(R)}</span>
        <span style="font-size:14px;font-weight:800;color:${fe};font-family:'Inter',sans-serif">${H.toFixed(1)}</span>
      </div>
    ...
    ${S}
  </div>`;const I=n.map(R=>(EXAM_DEFS[R.type]||[]).reduce((Y,oe)=>{var fe;return Y+Number(((fe=R.nets)==null?void 0:fe[oe])||0)},0)),f=Math.max(...I,10),k=600,w=160,E=40,y=16,z=28,T=30,M=k-E-y,_=w-z-T,D=n.length,C=R=>E+(D<=1?M/2:R/(D-1)*M),j=R=>z+_-R/f*_,$=f/4,A=$<=10?10:$<=20?20:$<=25?25:50,L=[];for(let R=0;R<=f+A;R+=A)R<=f*1.12&&L.push(R);const P=L.map(R=>{const H=j(R).toFixed(1);return`<line x1="${E}" y1="${H}" x2="${k-y}" y2="${H}" stroke="rgba(255,255,255,0.05)" stroke-width="1"/><text x="${E-5}" y="${(j(R)+3.5).toFixed(1)}" text-anchor="end" font-size="9" fill="rgba(200,215,230,0.28)" font-family="system-ui,sans-serif">${R}</text>`}).join(""),U=n.map((R,H)=>`${C(H).toFixed(1)},${j(I[H]).toFixed(1)}`).join(" "),N=`M ${C(0).toFixed(1)},${j(I[0]).toFixed(1)} `+n.slice(1).map((R,H)=>`L ${C(H+1).toFixed(1)},${j(I[H+1]).toFixed(1)}`).join(" ")+` L ${C(D-1).toFixed(1)},${(z+_).toFixed(1)} L ${C(0).toFixed(1)},${(z+_).toFixed(1)} Z`,G="ag"+Math.random().toString(36).slice(2,7),te=n.map((R,H)=>{const Y=C(H).toFixed(1),oe=j(I[H]).toFixed(1);return`<circle cx="${Y}" cy="${oe}" r="5" fill="${s}" stroke="#0d0d0f" stroke-width="2.5"/><text x="${Y}" y="${(j(I[H])-10).toFixed(1)}" text-anchor="middle" font-size="9.5" font-weight="700" fill="${s}" font-family="system-ui,sans-serif">${I[H].toFixed(0)}</text>`}).join(""),J=n.map((R,H)=>{let Y=R.name.replace(/Deneme\s+/,"#").replace(/^(TYT|AYT-SAY|AYT-EA|AYT-SOZ)\s+/,"");return Y.length>7&&(Y=Y.slice(0,6)+"…"),`<text x="${C(H).toFixed(1)}" y="${(w-T+14).toFixed(1)}" text-anchor="middle" font-size="9" fill="rgba(200,215,230,0.35)" font-family="system-ui,sans-serif">${g(Y)}</text>`}).join(""),X=`<svg viewBox="0 0 ${k} ${w}" style="width:100%;height:auto;display:block" xmlns="http://www.w3.org/2000/svg">
  ...
  ${P}
  <path d="${N}" fill="url(#${G})"/>
  <polyline points="${U}" fill="none" stroke="${s}" stroke-width="2.5" stroke-linejoin="round" stroke-linecap="round"/>
  ${te}${J}
    ...
    ${o}`}window._krRenderBody=Kn;function Xi(e){Yn=e;const t=l.exams.find(n=>n.studentId===e&&n.examDetails&&Object.keys(n.examDetails).length);Ie=(t==null?void 0:t.type)||"TYT",Kn(),O("konuRaporuModal")}window.openKonuRaporu=Xi;function Qi(e){const t=l.exams.find(n=>n.id===e);document.getElementById("cmExamId").value=e,document.getElementById("cmText").value=(t==null?void 0:t.coachComment)||"",O("commentModal")}async function eo(){const e=document.getElementById("cmExamId").value,t=document.getElementById("cmText").value.trim();await b.from("exams").update({coach_comment:t}).eq("id",e);const n=l.exams.find(a=>a.id===e);n&&(n.coachComment=t),F("commentModal"),Oe(),h("Yorum kaydedildi ✓")}async function to(e){await ae("Bu denemeyi silmek istediğinizden emin misiniz?")&&(await b.from("exams").delete().eq("id",e),l.exams=l.exams.filter(t=>t.id!==e),Oe(),h("Silindi"))}function On(){const e=document.getElementById("view-messages");e.innerHTML=`<div class="sh" style="margin-bottom:14px"><h2>Mesajlar</h2></div>
  ...
  <div class="msg-input-area">
  ...
  </div>`}window._pickMsgImg=function(e,t,n){const a=e.files[0];if(!a)return;if(a.size>5*1024*1024){h("Dosya max 5 MB olabilir"),e.value="";return}Be={file:a};const i=document.getElementById("msgImgPreview"),o=document.getElementById("msgImgThumb"),s=document.getElementById("msgImgName");if(a.type.startsWith("image/")){const r=new FileReader;r.onload=d=>{o.src=d.target.result,o.style.display="block"},r.readAsDataURL(a)}else o.style.display="none";s.textContent=a.name,i.style.display="flex",e.value=""};window._cancelMsgImg=function(){Be=null,document.getElementById("msgImgPreview").style.display="none"};window._handleMsgPaste=function(e,t,n){var i;const a=(i=e.clipboardData)==null?void 0:i.items;if(a){for(const o of a)if(o.type.startsWith("image/")){e.preventDefault();const s=o.getAsFile();if(!s)return;if(s.size>5*1024*1024){h("Dosya max 5 MB olabilir");return}Be={file:s};const r=new FileReader;r.onload=d=>{const c=document.getElementById("msgImgPreview"),p=document.getElementById("msgImgThumb"),m=document.getElementById("msgImgName");p.src=d.target.result,p.style.display="block",m.textContent="Yapıştırılan görsel",c&&(c.style.display="flex")},r.readAsDataURL(s);return}}};async function ao(e,t){var d,c,p;const n=document.getElementById("msgInput"),a=n.value.trim();if(!a&&!Be)return;const i=x.coachId||((d=l.students.find(m=>m.id===e))==null?void 0:d.coachId)||((c=l.students.find(m=>m.id===x.studentId))==null?void 0:c.coachId);let o=null;if(Be){const m=Be.file,v=((p=m.name)!=null&&p.includes(".")?m.name.split(".").pop():"")||(m.type==="image/png"?"png":m.type==="image/webp"?"webp":"jpg"),S=`${e}/${Date.now()}.${v}`,{error:I}=await b.storage.from("chat_images").upload(S,m,{upsert:!0});if(I){h("Görsel yüklenemedi: "+I.message);return}const{data:f}=b.storage.from("chat_images").getPublicUrl(S);o=f.publicUrl,Be=null,document.getElementById("msgImgPreview").style.display="none"}const{data:s,error:r}=await b.from("messages").insert({student_id:e,coach_id:i,from_role:t,text:a||null,image_url:o,read:!1}).select().single();if(r){h("Hata: "+r.message);return}l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:s.id,from:t,text:a||"",image_url:o,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),n.value="",n.style.height="auto",currentTab==="messages"&&(document.getElementById("msgMain").innerHTML=Te(e,"coach"),Ee()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=Te(e,"student"),Ee()),t==="student"&&i&&b.auth.getSession().then(({data:{session:m}})=>{var v;const u=m==null?void 0:m.access_token;u&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${u}`},body:JSON.stringify({type:"new_message",coach_id:i,student_name:((v=x.dbUser)==null?void 0:v.full_name)||"Öğrenciniz",message_preview:a?a.slice(0,200):"📷 Görsel gönderdi"})}).catch(()=>{})})}function Ee(){setTimeout(()=>{const e=document.getElementById("msgBody");e&&(e.scrollTop=e.scrollHeight)},60)}function xt(){var u;const e=document.getElementById("view-portal");if(!e)return;let t=l.students.find(v=>v.id===x.studentId);if(!t&&l.students.length>0&&(t=l.students[0]),!t){e.innerHTML=`<div style="text-align:center;padding:60px 20px;color:var(--text-mid)">
      <div style="font-size:36px;margin-bottom:12px">⏳</div>
      <p style="font-size:14px">Profil yükleniyor...</p>
    </div>`,setTimeout(()=>{l.students.length&&xt()},800);return}x.studentId||(x.studentId=t.id),l.activeStuId=t.id;const n=ve(),a=`${t.id}_${n}`,i=l.tasks[a]||[],o=i.filter(v=>v.done).length,s=l.appointments.filter(v=>v.studentId===t.id&&v.date>=n).sort((v,S)=>v.date.localeCompare(S.date))[0],r=(l.messages[t.id]||[]).filter(v=>v.from==="coach"&&!v.read).length,d=((u=l.konuMastery)==null?void 0:u[t.id])||{},c=[],p=new Date;p.setDate(p.getDate()-30),Object.entries(d).forEach(([v,S])=>{Object.entries(S).forEach(([I,f])=>{if(f.status==="td"||f.status==="not_started")return;const k=f.last_review_date?new Date(f.last_review_date):null,w=k?Math.floor((Date.now()-k.getTime())/864e5):999,E=f.stars<=2,y=w>20;(E||y)&&c.push({konu:I,subject:v,stars:f.stars,daysSince:w})})}),c.sort((v,S)=>v.stars-S.stars||S.daysSince-v.daysSince);const m=c.length>0?`
    ...
    <div class="portal-grid">
        ...
        ${i.length?`
          ${i.map((v,S)=>`
            <div data-task-id="${v._id}" class="task-card task-${v.type} ${v.done?"done":""}" style="margin-bottom:6px">
              ...
              <div class="tc-body">
                <div class="tc-type">${Xe(v.type)}${v.exam?" · "+v.exam:""}</div>
    ...
    </div>`}async function io(e,t){var s;const n=l.students.find(r=>r.id===x.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(s=l.tasks[a])==null?void 0:s[t];if(!i)return;const o=!i.done;await b.from("tasks").update({done:o}).eq("id",i._id),i.done=o,xt()}function _e(){const e=l.students.find(d=>d.id===x.studentId);if(!e)return;const t=document.getElementById("view-sportal"),n=e.weekStart??0,a=ee(l.weekOffset,n),i=V(a,6),o=ve(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let d=0;d<7;d++){const c=V(a,d),p=K(c),m=p===o,u=`${e.id}_${p}`,v=l.tasks[u]||[],S=v.reduce((E,y)=>E+Number(y.duration),0),I=v.reduce((E,y)=>E+(y.done?Number(y.duration):0),0);DAYS_TR[(n+d)%7];const f=[...v];s==="hourly"&&f.sort((E,y)=>E.start_time&&!y.start_time?-1:!E.start_time&&y.start_time?1:E.start_time&&y.start_time?E.start_time.localeCompare(y.start_time):0);const k=f.map(E=>{const y=v.indexOf(E),z=E.start_time?`<div class="tc-time-badge">🕒 ${E.start_time}</div>`:"";return`
      ...
      <div class="day-tasks-list">${k||'<div class="empty" style="padding:8px 0"><p style="font-size:11px">Görev yok</p></div>'}</div>
    </div>`}t.innerHTML=`
  ...
  </div>`}function lo(e){const t=e.student_feedback||{};if(!(t.status||t.focus||t.difficulty||t.time_spent>0||t.blocker))return"";const a={completed:{l:"Tamamladı",c:"#3ecf8e",bg:"rgba(62,207,142,.1)"},partial:{l:"Kısmen Tamamladı",c:"#f0a500",bg:"rgba(240,165,0,.1)"},failed:{l:"Yapamadı",c:"#ef4444",bg:"rgba(239,68,68,.1)"}},i={1:"Çok Kolay",2:"Kolay",3:"Orta",4:"Zor",5:"Çok Zor"},o={time:"Zamanı yetmedi",topic:"Konuyu anlayamadı",hard:"Kaynak çok zordu",moti:"Motivasyon yok"},s=a[t.status],r=t.time_spent,d=r>0?(Math.floor(r/60)>0?Math.floor(r/60)+"sa ":"")+(r%60>0?r%60+"dk":""):null,c=t.focus?"★".repeat(t.focus)+"☆".repeat(5-t.focus):null,p={1:"#3ecf8e",2:"#86efac",3:"#f0a500",4:"#fb923c",5:"#ef4444"},m=t.difficulty?p[t.difficulty]:"var(--text-mid)";return`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:12px 16px;margin-bottom:14px">
  ...
  </div>`}async function Kt(e,t,n){var v,S,I,f;const i=`${x.role==="student"?x.studentId:l.activeStuId}_${e}`,o=(v=l.tasks[i])==null?void 0:v[t];if(!o)return;if(n==="coach"&&o._id){const{data:k}=await b.from("tasks").select("*").eq("id",o._id).single();k&&(o.done=k.done,o.student_note=k.student_note||"",o.student_result=k.student_result||null,o.student_feedback=k.student_feedback||null)}let s=document.getElementById("taskDetailModal");s||(s=document.createElement("div"),s.id="taskDetailModal",s.className="modal-bg",document.body.appendChild(s),s.addEventListener("click",k=>{k.target===s&&s.classList.remove("open")}));const r={soru:"var(--blue)",konu:"#c084fc",deneme:"var(--accent)",diger:"var(--text-mid)"},d={soru:"Soru Bankası",konu:"Konu Anlatımı",deneme:"Deneme",diger:"Diğer"},c=r[o.type]||"var(--accent)",p=o.type==="konu",m=o.task_items||[];let u="";m.length>0?u=`<div style="margin-bottom:14px">
      ...
      <div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;overflow:hidden;max-height:200px;overflow-y:auto">
        ${m.map((k,w)=>`
          <label style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid var(--border);${w===m.length-1?"border-bottom:none":""};cursor:${n==="coach"?"default":"pointer"};transition:background .1s"
            ...
            <input type="checkbox" ${k.done?"checked":""} ${n==="coach"?"disabled":""} onchange="toggleDetailItem('${e}',${t},${w},'${n}')"
            ...
            <div style="flex:1;min-width:0">
              <div style="font-size:13px;font-weight:600;line-height:1.4;${k.done?"text-decoration:line-through;color:var(--text-dim);":""}">${g(k.label||`Ders ${w+1}`)}</div>
              <div style="font-size:11px;color:var(--text-mid);margin-top:2px">⏱ ${k.soru>0?p?k.soru+" dk":k.soru+" soru":"?"}</div>
            </div>
            ${k.url?`<a href="${g(k.url)}" target="_blank" onclick="event.stopPropagation()"
    ...
    ${(()=>{var w;const k=di(o.exam,o.subject);return k?(ce=[...((w=o.student_result)==null?void 0:w.yanlis_konular)||[]],`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:14px 16px;margin-bottom:14px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:0">${k.map(E=>{const y=ce.includes(E);return`<span ${n==="coach"?"":`onclick="toggleKonuChip(this,'${E.replace(/'/g,"\\'")}')"`}
  ...
  </div>`,O("taskDetailModal")}async function co(e,t,n){var s;if(n==="coach")return;const i=`${x.role==="student"?x.studentId:l.activeStuId}_${e}`,o=(s=l.tasks[i])==null?void 0:s[t];o&&(o.done=!o.done,o.task_items&&Array.isArray(o.task_items)&&o.task_items.forEach(r=>{r.done=o.done}),await b.from("tasks").update({done:o.done,task_items:o.task_items||null}).eq("id",o._id),Kt(e,t,n),n==="student"?_e():W())}async function po(e,t,n,a){var d;if(a==="coach")return;const o=`${x.role==="student"?x.studentId:l.activeStuId}_${e}`,s=(d=l.tasks[o])==null?void 0:d[t];if(!s||!s.task_items)return;s.task_items[n].done=!s.task_items[n].done;const r=s.task_items.every(c=>c.done);s.done=r,B(!0),await b.from("tasks").update({task_items:s.task_items,done:s.done}).eq("id",s._id),B(!1),Kt(e,t,a),a==="student"?_e():W(),h("İlerleme kaydedildi ✓")}function mo(e,t){var i,o,s;e.closest("div").querySelectorAll("button[data-speed]").forEach(r=>{const d=r.dataset.speed===t;r.style.borderColor=d?"var(--accent)":"var(--border)",r.style.background=d?"var(--accent-dim)":"var(--surface2)",r.style.color=d?"var(--accent)":"var(--text-mid)"}),document.getElementById("tdSpeed").value=t;const n=parseFloat(t),a=document.getElementById("speedCalc");if(a){const r=parseInt(((s=(o=(i=a.closest("[id=speedInfo]"))==null?void 0:i.textContent)==null?void 0:o.match(/Toplam (\d+) dk/))==null?void 0:s[1])||0);a.textContent=Math.ceil(r/n)+" dk",document.getElementById("tdDuration").value=Math.ceil(r/n)}}async function uo(e,t,n){var f,k,w,E,y;if(n==="coach")return;const i=`${x.role==="student"?x.studentId:l.activeStuId}_${e}`,o=(f=l.tasks[i])==null?void 0:f[t];if(!o)return;const s=((k=document.getElementById("tdNote"))==null?void 0:k.value.trim())||"",r={student_note:s},d=parseInt((w=document.getElementById("fbHour"))==null?void 0:w.value)||0,c=parseInt((E=document.getElementById("fbMin"))==null?void 0:E.value)||0,p=d*60+c,m={status:Me.status||null,time_spent:p>0?p:((y=o.student_feedback)==null?void 0:y.time_spent)||null,focus:Me.focus||null,difficulty:Me.difficulty||null,blocker:Me.blocker||null};(m.status||m.focus||m.difficulty||p>0)&&(r.student_feedback=m,o.student_feedback=m,m.status&&(r.done=m.status!=="failed",o.done=r.done));const u=document.getElementById("tdDogru"),v=document.getElementById("tdYanlis"),S=document.getElementById("tdBos");if(u!==null){const z=parseInt(u.value)||0,T=parseInt(v.value)||0,M=parseInt(S.value)||0;(z>0||T>0||M>0||ce.length>0)&&(r.student_result={dogru:z,yanlis:T,bos:M,yanlis_konular:[...ce],ts:new Date().toISOString()},o.student_result=r.student_result)}if(!o._id){h("Hata: görev ID bulunamadı");return}const{error:I}=await b.from("tasks").update(r).eq("id",o._id);if(I){h("Kaydetme hatası: "+I.message),console.error("saveTaskDetail error",I,r);return}o.student_note=s,F("taskDetailModal"),h("Kaydedildi ✓"),n==="student"?_e():W()}function Ot(){const e=l.students.find(o=>o.id===x.studentId);if(!e)return;const t=document.getElementById("view-sexams"),n=[...l.exams].filter(o=>o.studentId===e.id).sort((o,s)=>s.date.localeCompare(o.date));let a="";if(n.length>1){const o=[...n].sort((r,d)=>r.date.localeCompare(d.date)).slice(-8),s=Math.max(...o.map(r=>(EXAM_DEFS[r.type]||[]).reduce((c,p)=>{var m;return c+Number(((m=r.nets)==null?void 0:m[p])||0)},0)),1);a=`<div class="card cp" style="margin-bottom:16px">
    ...
    ${a}${i}`}function Fn(e){var n;const t=e?l.exams.find(a=>a.id===e):null;document.getElementById("emTitle").textContent=t?"Sonucu Düzenle":"Deneme Sonucu Gir",document.getElementById("emId").value=e||"",document.getElementById("emName").value=(t==null?void 0:t.name)||"",document.getElementById("emDate").value=(t==null?void 0:t.date)||K(new Date),document.getElementById("emStudentWrap").style.display="none",document.getElementById("emStudent").innerHTML=`<option value="${x.studentId}">${g(((n=l.students.find(a=>a.id===x.studentId))==null?void 0:n.name)||"")}</option>`,document.getElementById("emExamType").value=(t==null?void 0:t.type)||"TYT",document.getElementById("emNote").value=(t==null?void 0:t.note)||"",Ft(),t!=null&&t.examDetails&&Object.entries(t.examDetails).forEach(([a,i])=>{const o=document.getElementById(`ed_${a}_d`),s=document.getElementById(`ed_${a}_y`),r=document.getElementById(`ed_${a}_b`);o&&(o.value=i.dogru||0,s.value=i.yanlis||0,r.value=i.bos||0),ne[a]={...i},Un(a),(i.yanlis_konular||[]).forEach(d=>{document.querySelectorAll(`#konu_acc_${a.replace(/\s/g,"_")} span`).forEach(p=>{p.textContent.trim()===d&&(p.style.borderColor="var(--red)",p.style.background="rgba(255,92,122,.12)",p.style.color="var(--red)")})})}),O("examModal")}function go(e){document.getElementById("emStudentWrap").style.display="",document.getElementById("emStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${g(t.name)}</option>`).join(""),Fn(e),document.getElementById("emStudentWrap").style.display=""}let ne={};function vo(e,t,n){ne[t]||(ne[t]={dogru:0,yanlis:0,bos:0,yanlis_konular:[]});const a=ne[t].yanlis_konular,i=a.indexOf(n);i===-1?(a.push(n),e.style.borderColor="var(--red)",e.style.background="rgba(255,92,122,.12)",e.style.color="var(--red)"):(a.splice(i,1),e.style.borderColor="var(--border)",e.style.background="var(--surface)",e.style.color="var(--text-mid)")}window.toggleExamKonuChip=vo;function Un(e){var c,p,m,u;const t=parseInt((c=document.getElementById(`ed_${e}_d`))==null?void 0:c.value)||0,n=parseInt((p=document.getElementById(`ed_${e}_y`))==null?void 0:p.value)||0,a=parseInt((m=document.getElementById(`ed_${e}_b`))==null?void 0:m.value)||0;ne[e]||(ne[e]={yanlis_konular:[]}),ne[e].dogru=t,ne[e].yanlis=n,ne[e].bos=a;const i=document.getElementById("emExamType").value,o=((u=EXAM_SORU[i])==null?void 0:u[e])||40,s=t+n+a,r=document.getElementById(`ed_${e}_net`),d=document.getElementById(`ed_${e}_warn`);r&&(r.textContent=Math.max(0,t-n/4).toFixed(2)),d&&(d.style.display=s>o?"":"none"),Vi()}window.updateExamNet=Un;function fo(e){const t=document.getElementById(`konu_acc_${e.replace(/\s/g,"_")}`);t&&(t.style.display=t.style.display==="none"?"":"none")}window.toggleKonuAccordion=fo;function Ft(){const e=document.getElementById("emExamType").value,t=EXAM_DEFS[e]||[];ne={};const n=document.getElementById("emPuanDisplay");n&&(n.innerHTML=""),document.getElementById("netInputsWrap").innerHTML=t.map(a=>{var d;const i=((d=EXAM_SORU[e])==null?void 0:d[a])||40,s=(EXAM_KONU_MAP[`${e}_${a}`]||[]).flatMap(c=>We[c]||[]),r=s.length?`
      ...
      ${r}
    </div>`}).join("")}async function yo(){var r,d;const e=document.getElementById("emName").value.trim();if(!e)return h("Sınav adı girin!");const t=document.getElementById("emExamType").value,n={};(EXAM_DEFS[t]||[]).forEach(c=>{const p=ne[c]||{};n[c]=Math.max(0,(p.dogru||0)-(p.yanlis||0)/4)});const a=document.getElementById("emId").value,i=document.getElementById("emStudent").value,o={name:e,date:document.getElementById("emDate").value,student_id:i,coach_id:x.coachId||((r=l.students.find(c=>c.id===i))==null?void 0:r.coachId),exam_type:t,nets:n,exam_details:ne,student_note:document.getElementById("emNote").value.trim()};async function s(c,p,m){var u,v,S;if(p){const{error:I}=await b.from("exams").update(c).eq("id",m);if((u=I==null?void 0:I.message)!=null&&u.includes("exam_details")){const{exam_details:f,...k}=c;return b.from("exams").update(k).eq("id",m)}return{error:I}}else{const I=await b.from("exams").insert(c).select().single();if((S=(v=I.error)==null?void 0:v.message)!=null&&S.includes("exam_details")){const{exam_details:f,...k}=c;return b.from("exams").insert(k).select().single()}return I}}if(a){const{error:c}=await s(o,!0,a);if(c)return h("Hata: "+c.message);const p=l.exams.find(m=>m.id===a);p&&Object.assign(p,{name:o.name,date:o.date,studentId:i,type:t,nets:n,examDetails:ne,note:o.student_note}),h("Güncellendi ✓")}else{const{data:c,error:p}=await s(o,!1,null);if(p)return h("Hata: "+p.message);l.exams.push({id:c.id,studentId:c.student_id,name:c.name,date:c.date,type:c.exam_type,nets:c.nets||{},examDetails:c.exam_details||{},note:c.student_note,coachComment:""}),h("Deneme eklendi ✓")}if(F("examModal"),x.role==="student"?Ot():Oe(),x.role==="coach"||x.role==="developer")try{const c=[];Object.values(ne||{}).forEach(m=>{var u;(u=m==null?void 0:m.yanlis_konular)!=null&&u.length&&c.push(...m.yanlis_konular)}),ce!=null&&ce.length&&c.push(...ce);const p=[...new Set(c)];if(p.length>0&&i){const m=((d=l.konuMastery)==null?void 0:d[i])||{},u=[];if(Object.entries(m).forEach(([v,S])=>{Object.entries(S).forEach(([I,f])=>{p.includes(I)&&(f.status==="td"?u.push({konu:I,subject:v,type:"td_broken",stars:f.stars}):f.stars>=5&&u.push({konu:I,subject:v,type:"high_star_wrong",stars:f.stars}))})}),u.length>0){const v=u.filter(f=>f.type==="td_broken"),S=u.filter(f=>f.type==="high_star_wrong");let I="⚠️ Mastery Önerileri: ";v.length>0&&(I+=`${v.map(f=>f.konu).join(", ")} TD'den düştü! `),S.length>0&&(I+=`${S.map(f=>f.konu).join(", ")} için yıldız düşürmeyi düşün.`),setTimeout(()=>{const f=document.createElement("div");f.style.cssText="position:fixed;bottom:80px;right:16px;max-width:360px;background:var(--surface);border:1.5px solid var(--accent);border-radius:12px;padding:14px 16px;box-shadow:var(--shadow-lg);z-index:99999;animation:slideIn .3s ease",f.innerHTML=`
              <div style="display:flex;align-items:flex-start;gap:10px">
                <span style="font-size:20px;flex-shrink:0">⚠️</span>
                <div style="flex:1">
                  <div style="font-size:13px;font-weight:800;margin-bottom:6px">Deneme → Konu Mastery Önerisi</div>
                  ${v.length>0?`<div style="font-size:11px;color:var(--red);margin-bottom:4px">🔴 TD'den düşenler: <b>${v.map(k=>k.konu).join(", ")}</b></div>`:""}
                  ${S.length>0?`<div style="font-size:11px;color:var(--accent)">🟡 Yıldız düşürmeyi düşün: <b>${S.map(k=>k.konu).join(", ")}</b></div>`:""}
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      <div class="card cp">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:80px">
          ${k.map((y,z)=>`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
            <div style="font-size:10px;color:var(--text-mid);font-weight:600">${w[z]}</div>
            <div style="width:100%;background:var(--accent);border-radius:3px 3px 0 0;height:${Math.max(Math.round(w[z]/E*100),4)}%;min-height:3px;opacity:.8"></div>
...
Bu işlem geri alınamaz.`)){B(!0);try{const{data:{session:n}}=await b.auth.getSession(),a=await fetch("/api/delete-user",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${(n==null?void 0:n.access_token)||""}`},body:JSON.stringify({targetUserId:e})}),i=await a.json();if(!a.ok)throw new Error(i.error||"Sunucu hatası");h(`🗑 ${t} silindi`),tt()}catch(n){h("Hata: "+n.message)}finally{B(!1)}}}function ko(e,t,n,a){let i=document.getElementById("planMgmtModal");i||(i=document.createElement("div"),i.id="planMgmtModal",i.className="modal-bg",i.innerHTML=`<div class="modal" style="max-width:400px">
    ...
    </div>`,document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")}),document.getElementById("planStatus").addEventListener("change",function(){document.getElementById("trialEndField").style.display=this.value==="trial"?"":"none"})),document.getElementById("planModalTitle").textContent=`Plan Yönet — ${t}`,document.getElementById("planUserId").value=e,document.getElementById("planStatus").value=n||"trial",document.getElementById("trialEndField").style.display=n==="trial"||!n?"":"none",a?document.getElementById("planTrialEnd").value=a.split("T")[0]:document.getElementById("planTrialEnd").value="",O("planMgmtModal")}async function wo(){const e=document.getElementById("planUserId").value,t=document.getElementById("planStatus").value,n=document.getElementById("planTrialEnd").value,a={plan:t};t==="trial"&&n?a.trial_ends_at=n:t!=="trial"&&(a.trial_ends_at=null),B(!0);const{error:i}=await b.from("users").update(a).eq("id",e);if(B(!1),i)return h("Hata: "+i.message);h(`Plan güncellendi: ${{trial:"Deneme",active:"Aktif",paused:"Duraklatıldı",cancelled:"İptal"}[t]||t} ✓`),F("planMgmtModal"),tt()}let Ge=[];async function nt(){const e=document.getElementById("view-dev-resources"),{data:t}=await b.from("resources").select("*").order("resource_type,exam_type,subject,name");Ge=t||[];const n=Ge.filter(i=>i.resource_type!=="playlist"),a=Ge.filter(i=>i.resource_type==="playlist");e.innerHTML=`
    ...
    <div class="stats-row" style="margin-bottom:20px">
      ...
      <div class="stat-card"><div class="stat-label">Toplam Kaynak</div><div class="stat-val">${Ge.length}</div></div>
    </div>
    ...
    </div>`}function $o(){let e=document.getElementById("playlistModal");e||(e=document.createElement("div"),e.id="playlistModal",e.className="modal-bg",document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),e.innerHTML=`<div class="modal modal-lg">
...
`).map(r=>r.trim()).filter(Boolean);let o=[];a?o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",url:d[1]||"",topic:"",soru:parseInt(d[2])||0}}):o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",soru:parseInt(d[1])||0}});const s={exam_type:document.getElementById("rmExam").value,subject:t,publisher:document.getElementById("rmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:o,active:document.getElementById("rmActive").value==="true",resource_type:a?"playlist":"book"};n?(await b.from("resources").update(s).eq("id",n),h("Güncellendi ✓")):(await b.from("resources").insert(s),h("Kaynak eklendi ✓")),F("resourceModal"),nt()}async function Io(e){await ae("Bu kaynağı silmek istediğinizden emin misiniz?")&&(await b.from("resources").delete().eq("id",e),h("Silindi"),nt())}async function bt(){const e=document.getElementById("view-dev-finance"),[{data:t},{data:n}]=await Promise.all([b.from("subscriptions").select("*,users(full_name,color)").order("created_at",{ascending:!1}),b.from("payments").select("*,users(full_name)").order("payment_date",{ascending:!1}).limit(20)]),a=(n||[]).filter(o=>o.status==="completed").reduce((o,s)=>o+Number(s.amount),0),i=(t||[]).filter(o=>o.status==="active").length;e.innerHTML=`
    ...
    </div>`}function zo(){let e=document.getElementById("paymentModal");e||(e=document.createElement("div"),e.id="paymentModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('paymentModal')">×</button>
      <h2>Ödeme Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pmStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${g(t.name)}</option>`).join(""),O("paymentModal")}async function Bo(){const e=parseFloat(document.getElementById("pmAmount").value);if(!e)return h("Tutar girin!");await b.from("payments").insert({student_id:document.getElementById("pmStudent").value,amount:e,method:document.getElementById("pmMethod").value,payment_date:document.getElementById("pmDate").value,description:document.getElementById("pmDesc").value,status:"completed"}),h("Ödeme kaydedildi ✓"),F("paymentModal"),bt()}function Mo(){let e=document.getElementById("subModal");e||(e=document.createElement("div"),e.id="subModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('subModal')">×</button>
      <h2>Abonelik Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("sbStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${g(t.name)}</option>`).join(""),O("subModal")}async function Ao(){const e=parseFloat(document.getElementById("sbAmount").value);if(!e)return h("Tutar girin!");await b.from("subscriptions").insert({student_id:document.getElementById("sbStudent").value,plan:document.getElementById("sbPlan").value,amount:e,start_date:document.getElementById("sbStart").value,end_date:document.getElementById("sbEnd").value||null,status:document.getElementById("sbStatus").value,notes:document.getElementById("sbNotes").value}),h("Abonelik eklendi ✓"),F("subModal"),bt()}async function at(){const e=document.getElementById("view-dev-announce"),{data:t}=await b.from("announcements").select("*").order("created_at",{ascending:!1}),n={info:"var(--blue)",warning:"var(--accent)",success:"var(--green)",urgent:"var(--red)"};e.innerHTML=`
    ...
    ${(t||[]).map(a=>`
      ...
      </div>`).join("")}`}function Do(){let e=document.getElementById("announceModal");e||(e=document.createElement("div"),e.id="announceModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('announceModal')">×</button>
      <h2>Yeni Duyuru</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),O("announceModal")}async function Co(){const e=document.getElementById("anTitle").value.trim(),t=document.getElementById("anBody").value.trim();if(!e||!t)return h("Başlık ve içerik zorunlu!");await b.from("announcements").insert({title:e,body:t,type:document.getElementById("anType").value,target:document.getElementById("anTarget").value,active:!0}),h("Duyuru yayınlandı ✓"),F("announceModal"),at()}async function Lo(e,t){await b.from("announcements").update({active:t}).eq("id",e),at()}async function jo(e){await ae("Bu duyuruyu silmek istediğinizden emin misiniz?")&&(await b.from("announcements").delete().eq("id",e),h("Silindi"),at())}let Re=null,gt=null,pe=null,$t=null,Pe=[],me=[],ke="welcome";async function Fe(){const e=document.getElementById("view-dev-tickets");if(!e)return;const{data:t,error:n}=await b.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").order("updated_at",{ascending:!1});Pe=t||[],!pe&&Pe.length>0&&(pe=Pe[0].id),e.innerHTML=`
  ...
  `,Ho(),$t&&clearInterval($t),$t=setInterval(Ro,4e3)}function Po(e){pe=e,Fe()}async function Ro(){if(!pe||!document.getElementById("devChatArea"))return;const{data:t,error:n}=await b.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").eq("id",pe).single();if(n||!t)return;let a=[];try{a=JSON.parse(t.body),Array.isArray(a)||(a=[{sender:"user",text:t.body,time:t.created_at}])}catch{a=[{sender:"user",text:t.body,time:t.created_at}]}const i=document.getElementById("devChatMessages");if(i){const o=i.scrollTop,s=i.scrollHeight-i.clientHeight-o<40;i.innerHTML=a.map(r=>{const d=r.sender==="emin",c=d?"Kurucu / Destek":r.sender==="ai"?"Yapay Zeka":r.name||"Kullanıcı",p=d?"var(--blue)":r.sender==="ai"?"var(--surface2)":"var(--accent)",m=d?"#fff":r.sender==="ai"?"var(--text)":"var(--on-accent)",u=d?"flex-end":"flex-start",v=d?"14px 14px 4px 14px":"14px 14px 14px 4px",S=new Date(r.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join(""),s&&(i.scrollTop=i.scrollHeight)}}function Ho(){var s,r,d;const e=document.getElementById("devChatArea");if(!e)return;const t=Pe.find(c=>c.id===pe);if(!t){e.innerHTML=`
    ...
    <div id="devChatMessages" style="flex:1; overflow-y:auto; padding:20px; display:flex; flex-direction:column; gap:12px; background:var(--surface)">
      ${i.map(c=>{const p=c.sender==="emin",m=p?"Kurucu / Destek":c.sender==="ai"?"Yapay Zeka":c.name||"Kullanıcı",u=p?"var(--blue)":c.sender==="ai"?"var(--surface2)":"var(--accent)",v=p?"#fff":c.sender==="ai"?"var(--text)":"var(--on-accent)",S=p?"flex-end":"flex-start",I=p?"14px 14px 4px 14px":"14px 14px 14px 4px",f=new Date(c.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
          <div style="align-self:${S}; max-width:80%; display:flex; flex-direction:column; align-items:${p?"flex-end":"flex-start"}">
            ...
            <div style="padding:10px 14px; border-radius:${I}; background:${u}; color:${v}; font-size:13px; line-height:1.5; word-wrap:break-word; white-space:pre-wrap">${g(c.text)}</div>
  ...
  `;const o=document.getElementById("devChatMessages");o&&(o.scrollTop=o.scrollHeight)}async function No(){const e=document.getElementById("devReplyInput"),t=e.value.trim();if(!t||!pe)return;e.value="",B(!0);const{data:n}=await b.from("tickets").select("body").eq("id",pe).single();let a=[];if(n&&n.body)try{a=JSON.parse(n.body)}catch{a=[{sender:"user",text:n.body,time:new Date().toISOString()}]}const i={sender:"emin",text:t,time:new Date().toISOString(),name:"Kurucu / Destek"};a.push(i);const{error:o}=await b.from("tickets").update({body:JSON.stringify(a),reply:t,status:"resolved",updated_at:new Date().toISOString()}).eq("id",pe);if(B(!1),o){h("Hata: "+o.message);return}h("Yanıt gönderildi ✓"),Fe()}async function Yo(e,t){await b.from("tickets").update({status:t,updated_at:new Date().toISOString()}).eq("id",e),h("Durum güncellendi ✓"),Fe()}async function Ko(e){await ae("Bu talebi silmek istediğinizden emin misiniz?")&&(await b.from("tickets").delete().eq("id",e),h("Silindi"),pe=null,Fe())}function Oo(){ht()}async function ht(){let e=document.getElementById("supportChatModal");e||(e=document.createElement("div"),e.id="supportChatModal",e.className="modal-bg",e.style.zIndex="99999999",e.innerHTML=`
    ...
    `}).join(""),a&&(t.scrollTop=t.scrollHeight)}function Fo(){ke="ai",me=[{sender:"ai",text:"Merhaba! Ben Rostrum Akademi Yapay Zeka Asistanıyım. 🤖 Size nasıl yardımcı olabilirim?",time:new Date().toISOString()}],Ve(me)}function Uo(){ke="emin_start";const e=document.getElementById("supportMessages");e&&(e.innerHTML=`
      <div style="text-align:center;padding:40px 20px">
    ...
    </div>`,i.appendChild(s)}),document.body.appendChild(i),setTimeout(()=>i.remove(),8e3)}(()=>{const e=document.createElement("style");e.textContent=".role-dev{background:rgba(192,132,252,.15);color:#c084fc;}",document.head.appendChild(e)})();function Vn(e){return`ra_ob_${x.coachId}_${e}`}function zt(e){return localStorage.getItem(Vn(e))==="1"}function Wo(e){localStorage.setItem(Vn(e),"1"),Zn(),["student","program","report"].every(n=>zt(n))&&Vo()}async function Vo(){const e=document.getElementById("obWidget");e&&(e.innerHTML=`<div style="padding:20px;text-align:center">
    ...
    </div>`,setTimeout(()=>e.remove(),3e3)),await b.from("workspaces").update({onboarding_done:!0}).eq("coach_id",x.coachId),l.workspace&&(l.workspace.onboarding_done=!0)}function Zn(){const e=document.getElementById("obWidget");if(!e)return;const t=[{id:"student",icon:"👤",label:"İlk öğrencinizi ekleyin",action:"window.openStudentModal?.()",btnLabel:"Ekle →"},{id:"program",icon:"📅",label:"Haftalık program oluşturun",action:"switchTab('program')",btnLabel:"Git →"},{id:"report",icon:"📄",label:"İlk raporunuzu gönderin",action:"switchTab('program')",btnLabel:"Git →"}],n=t.filter(i=>zt(i.id)).length,a=Math.round((n+1)/(t.length+1)*100);e.querySelector(".ob-body").innerHTML=t.map(i=>{const o=zt(i.id);return`<div style="display:flex;align-items:center;gap:10px;padding:9px 0;border-bottom:1px solid var(--border)">
  ...
  </div>`}let He=0;const Ne={};function Jo(){const e=l.students.find(i=>i.id===x.studentId);if(!e)return;const t=e.name.split(" ")[0],n=e.color||"var(--accent)";let a=document.getElementById("stuWelcomeModal");a||(a=document.createElement("div"),a.id="stuWelcomeModal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.85);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(8px)",document.body.appendChild(a)),He=0,Xn(a,t,n,e)}function Xn(e,t,n,a){const i=[()=>`<div style="text-align:center">
    ...
    ${o}
    ${i[He]()}
  </div>`,e.querySelectorAll(".sw-chip").forEach(s=>{s.addEventListener("click",function(){this.style.background=this.classList.contains("sel")?n:"var(--surface2)",this.style.borderColor=this.classList.contains("sel")?n:"var(--border)",this.style.color=this.classList.contains("sel")?"#fff":"var(--text)"})})}window._swNext=function(){var n,a,i,o,s,r,d;const e=document.getElementById("stuWelcomeModal");if(!e)return;He===1&&(Ne.target_university=((a=(n=document.getElementById("sw_uni"))==null?void 0:n.value)==null?void 0:a.trim())||"",Ne.target_department=((o=(i=document.getElementById("sw_dept"))==null?void 0:i.value)==null?void 0:o.trim())||"",Ne.struggling_subjects=((r=(s=document.getElementById("sw_struggle"))==null?void 0:s.value)==null?void 0:r.trim())||""),He++;const t=l.students.find(c=>c.id===x.studentId);Xn(e,((d=t==null?void 0:t.name)==null?void 0:d.split(" ")[0])||"",(t==null?void 0:t.color)||"var(--accent)",t)};window._swSkip=function(){var e;(e=document.getElementById("stuWelcomeModal"))==null||e.remove(),b.from("student_profiles").upsert({id:x.studentId}).then(()=>{})};window._swSave=async function(){var a,i,o,s,r;const e=((i=(a=document.getElementById("sw_motivation"))==null?void 0:a.value)==null?void 0:i.trim())||"",t=((s=(o=document.getElementById("sw_hours"))==null?void 0:o.value)==null?void 0:s.replace(/\D/g,""))||null,n={id:x.studentId,target_university:Ne.target_university||"",target_department:Ne.target_department||"",struggling_subjects:Ne.struggling_subjects||"",bio:e,daily_capacity:t?parseInt(t):null};B(!0,"Kaydediliyor...");try{await b.from("student_profiles").upsert(n)}catch(d){console.error(d)}B(!1),(r=document.getElementById("stuWelcomeModal"))==null||r.remove(),h("Profilin kaydedildi! 🎉"),ie("sportal")};let Tt=null;window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),Tt=e;const t=document.createElement("button");t.id="pwaInstallBtn",t.className="btn btn-ghost btn-sm",t.innerHTML="📲 Yükle",t.style.cssText="font-size:11px;padding:5px 10px",t.onclick=async()=>{Tt.prompt();const{outcome:n}=await Tt.userChoice;n==="accepted"&&(t.remove(),h("Uygulama yüklendi ✓"))},document.querySelector(".tbar-right").insertBefore(t,document.querySelector(".user-pill"))});async function Qn(){const e=l.students.find(T=>T.id===x.studentId);if(!e)return;const t=document.getElementById("view-sprofil");if(!t)return;const{data:n,error:a}=await b.from("student_profiles").select("*").eq("id",x.studentId).maybeSingle();a&&console.error("Öğrenci profili yüklenirken hata:",a);const i=(n==null?void 0:n.bio)||"",o=(n==null?void 0:n.school)||"",s=(n==null?void 0:n.grade)||"",r=(n==null?void 0:n.target_university)||"",d=(n==null?void 0:n.target_department)||"",c=(n==null?void 0:n.struggling_subjects)||"",p=(n==null?void 0:n.daily_capacity)||"",m=l.exams.filter(T=>T.studentId===e.id).sort((T,M)=>T.date.localeCompare(M.date)),u=m[m.length-1],v=u?(EXAM_DEFS[u.type]||[]).reduce((M,_)=>{var D;return M+Number(((D=u.nets)==null?void 0:D[_])||0)},0).toFixed(1):"—",S=ee(0,e.weekStart??0);let I=0,f=0;for(let T=0;T<7;T++){const M=l.tasks[`${e.id}_${K(V(S,T))}`]||[];I+=M.length,f+=M.filter(_=>_.done).length}const k=I>0?Math.round(f/I*100):0;let w=0;Object.keys(l.tasks).filter(T=>T.startsWith(e.id+"_")).forEach(T=>{w+=l.tasks[T].filter(M=>M.done).length});let E="";if(m.length>0){const T=m.slice(-6),M=Math.max(...T.map(_=>(EXAM_DEFS[_.type]||[]).reduce((C,j)=>{var $;return C+Number((($=_.nets)==null?void 0:$[j])||0)},0)),1);E=`
      <div class="card cp" style="margin-bottom:16px">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:90px;margin-top:12px">
          ${T.map(_=>{const C=(EXAM_DEFS[_.type]||[]).reduce((U,N)=>{var G;return U+Number(((G=_.nets)==null?void 0:G[N])||0)},0),j=Math.max(Math.round(C/M*100),4),$=T[T.indexOf(_)-1],A=$?(EXAM_DEFS[$.type]||[]).reduce((U,N)=>{var G;return U+Number(((G=$.nets)==null?void 0:G[N])||0)},0):C,L=C>A?"↑":C<A?"↓":"",P=C>A?"var(--green)":C<A?"var(--red)":"var(--text-dim)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
      ...
      </div>`}let y="";if(m.length>0){const T=u.type,_=(EXAM_DEFS[T]||[]).map(D=>{var A;const C=m.filter(L=>L.type===T).map(L=>{var P;return Number(((P=L.nets)==null?void 0:P[D])||0)}),j=C.length?C.reduce((L,P)=>L+P,0)/C.length:0,$=Number(((A=u.nets)==null?void 0:A[D])||0);return{f:D,avg:j.toFixed(1),last:$,color:Mt($)}});y=`
      <div class="card cp" style="margin-bottom:16px">
      ...
      </div>`}const z=l.appointments.filter(T=>T.studentId===e.id&&T.date>=ve()).sort((T,M)=>T.date.localeCompare(M.date)).slice(0,3);t.innerHTML=`
    <!-- HERO -->
    ...
    <div class="stats-row" style="margin-bottom:16px">
      ...
      <div class="stat-card">
        ...
        <div class="stat-val">${f}<span style="font-size:14px;color:var(--text-dim)">/${I}</span></div>
        <div style="font-size:11px;color:var(--text-mid);margin-top:4px">%${k} tamamlandı</div>
      </div>
      <div class="stat-card">
    ...
    </div>`}async function Xo(){const e=x.dbUser.id,t=document.getElementById("spBio").value.trim(),n=document.getElementById("spSchool").value.trim(),a=document.getElementById("spGrade").value.trim(),i=document.getElementById("spTargetUni").value.trim(),o=document.getElementById("spTargetDept").value.trim(),s=document.getElementById("spStruggling").value.trim(),r=parseInt(document.getElementById("spCapacity").value)||null,d={id:e,bio:t,school:n,grade:a,target_university:i,target_department:o,struggling_subjects:s,daily_capacity:r,updated_at:new Date().toISOString()},{error:c}=await b.from("student_profiles").upsert(d);h(c?"Profil kaydedilemedi: "+c.message:"Profil başarıyla güncellendi ✓")}async function Qo(){const e=document.getElementById("newPass1").value,t=document.getElementById("newPass2").value;if(!e)return h("Şifre girin!");if(e!==t)return h("Şifreler uyuşmuyor!");if(e.length<4)return h("En az 4 karakter olmalı");const{error:n}=await b.from("users").update({password_hash:e}).eq("id",x.studentId);if(n)return h("Hata: "+n.message);h("Şifre güncellendi ✓"),document.getElementById("newPass1").value="",document.getElementById("newPass2").value=""}async function es(){const e=document.getElementById("view-suyelik");if(!e)return;e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;height:200px"><div style="width:32px;height:32px;border:3px solid var(--accent);border-top-color:transparent;border-radius:50%;animation:spin .7s linear infinite"></div></div>',l.students.find(f=>f.id===x.studentId);const t=x.dbUser;let n=null;if(x.coachId){const{data:f}=await b.from("users").select("full_name,plan,trial_ends_at,created_at,email").eq("id",x.coachId).maybeSingle();n=f}const a=t!=null&&t.created_at?new Date(t.created_at):null,i=new Date,o=(n==null?void 0:n.plan)||"trial",s=o==="trial"?"Deneme Dönemi":o==="pro"?"Pro Üyelik":o==="premium"?"Premium Üyelik":o.charAt(0).toUpperCase()+o.slice(1),r=o==="trial"?"#f0a500":o==="pro"?"#3ecf8e":o==="premium"?"#8b5cf6":"#3ecf8e",d=o==="trial"?"#fff8e6":o==="pro"?"#e6faf3":o==="premium"?"#f3e8ff":"#e6faf3";let c=null;n!=null&&n.trial_ends_at?c=new Date(n.trial_ends_at):n!=null&&n.created_at&&(c=new Date(new Date(n.created_at).getTime()+14*24*60*60*1e3));const p=c?Math.max(0,Math.ceil((c-i)/(1e3*60*60*24))):null,m=a?Math.floor((i-a)/(1e3*60*60*24)):null,u=f=>f?f.toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"}):"—",v=p===null?"#888":p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444",S=p===null?"❓":p>7?"✅":p>3?"⚠️":"🔴",I=p===null?"Durum bilinmiyor":p>7?"Aktif":p>3?"Yakında Sona Eriyor":p===0?"Bugün Sona Eriyor":"Kritik — "+p+" gün";e.innerHTML=`
    <div style="max-width:480px;margin:0 auto;padding:16px">
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:16px">
        ${[{icon:"🎓",label:"Koçum",value:(n==null?void 0:n.full_name)||"—"},{icon:"📅",label:"Kayıt Tarihi",value:u(a)},{icon:"⏳",label:"Kullanım Süresi",value:m!==null?m+" gün":"—"},{icon:"📆",label:"Üyelik Sona Erme",value:u(c)},{icon:"⌛",label:"Kalan Süre",value:p!==null?`<span style="color:${v};font-weight:700">${p} gün</span>`:"—"}].map(({icon:f,label:k,value:w},E,y)=>`
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:18px;margin-bottom:16px">
        ...
        ${(()=>{const f=c&&a?Math.max(1,Math.ceil((c-a)/864e5)):14,k=Math.min(f,f-p),w=Math.min(100,Math.round(k/f*100)),E=p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444";return`
            <div style="display:flex;justify-content:space-between;font-size:11px;color:var(--text-dim);margin-bottom:6px">
              <span>${k} gün kullanıldı</span>
            ...
            <div class="profile-preview-card">
              <div class="preview-card-header">
                ...
                <div class="preview-header-info">
                  <div class="preview-name" id="prevName">${g(((v=x.dbUser)==null?void 0:v.full_name)||"Koç")}</div>
  ...
  `}async function as(e,t){const{error:n}=await b.from("match_requests").update({status:t}).eq("id",e);n?h("Durum güncellenirken hata: "+n.message):(h("Durum güncellendi ✓"),Wt())}async function is(e){const t=l.students.find(s=>s.id===e);if(!t)return;const{data:n}=await b.from("student_speeds").select("*").eq("student_id",e),a={};(n||[]).forEach(s=>{a[`${s.exam_type}_${s.subject}`]=s.secs_per_question});const i=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];let o=document.getElementById("speedModal");o||(o=document.createElement("div"),o.id="speedModal",o.className="modal-bg",document.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&o.classList.remove("open")})),o.innerHTML=`<div class="modal modal-lg">
  ...
  </div>`,O("speedModal")}async function os(e){const t=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];for(const{exam:n,sub:a}of t){const i=`${n}_${a}`,o=document.getElementById("spd_"+i);if(!o)continue;const s=parseInt(o.value)||180;await Bn(e,n,a,s)}F("speedModal"),h("Hız ayarları kaydedildi ✓")}async function ss(e){const t=l.students.find(o=>o.id===e);if(!t)return;const{data:n}=await b.from("student_notes").select("notes").eq("coach_id",x.coachId).eq("student_id",e).maybeSingle(),a=(n==null?void 0:n.notes)||"";let i=document.getElementById("studentNotesModal");i||(i=document.createElement("div"),i.id="studentNotesModal",i.className="modal-bg",document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")})),i.innerHTML=`<div class="modal">
  ...
  </div>`,O("studentNotesModal")}async function rs(e){const t=document.getElementById("studentNoteText").value,{error:n}=await b.from("student_notes").upsert({coach_id:x.coachId,student_id:e,notes:t,updated_at:new Date().toISOString()},{onConflict:"coach_id,student_id"});if(n){h("Not kaydedilemedi: "+n.message);return}h("Not kaydedildi ✓"),F("studentNotesModal")}function ls(e){let t=document.getElementById("reportModal");t||(t=document.createElement("div"),t.id="reportModal",t.className="modal-bg",t.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.classList.remove("open")}),document.getElementById("rpPeriod").addEventListener("change",function(){document.getElementById("rpCustomDates").style.display=this.value==="custom"?"":"none"})),document.getElementById("rpStuId").value=e;const n=new Date,a=new Date(n.getFullYear(),n.getMonth(),1);document.getElementById("rpStart").value=K(a),document.getElementById("rpEnd").value=K(n),document.getElementById("rpNote").value="",O("reportModal")}function Vt(){const e=document.getElementById("rpPeriod").value,t=new Date;if(e==="weekly"){const n=ee(0,0);return{start:K(n),end:K(V(n,6))}}else return e==="monthly"?{start:K(new Date(t.getFullYear(),t.getMonth(),1)),end:K(t)}:{start:document.getElementById("rpStart").value,end:document.getElementById("rpEnd").value}}function Zt(e,t=!1){var y,z,T,M;const n=l.students.find(_=>_.id===e);if(!n)return"";const{start:a,end:i}=Vt(),o=document.getElementById("rpNote").value.trim(),s=((y=l.workspace)==null?void 0:y.brand_name)||"Rostrum Akademi",r=((z=l.workspace)==null?void 0:z.brand_color)||"#f0a500",d=((T=x.dbUser)==null?void 0:T.full_name)||"Koç",c=[],p=new Date(a);for(;K(p)<=i;){const _=`${e}_${K(p)}`;(l.tasks[_]||[]).forEach(D=>c.push({...D,date:K(p)})),p.setDate(p.getDate()+1)}const m=c.length,u=c.filter(_=>_.done).length,v=m>0?Math.round(u/m*100):0,S=c.filter(_=>_.done).reduce((_,D)=>_+Number(D.duration||0),0),I={};c.forEach(_=>{const D=_.subject||"Diğer";I[D]||(I[D]={total:0,done:0}),I[D].total++,_.done&&I[D].done++});const f=l.exams.filter(_=>_.studentId===e&&_.date>=a&&_.date<=i).sort((_,D)=>_.date.localeCompare(D.date)),k=l.appointments.filter(_=>_.studentId===e&&_.date>=a&&_.date<=i).sort((_,D)=>_.date.localeCompare(D.date)),w=`${new Date(a+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})} – ${new Date(i+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})}`;let E="";if(f.length>1){const _=Math.max(...f.map($=>(EXAM_DEFS[$.type]||[]).reduce((A,L)=>{var P;return A+Number(((P=$.nets)==null?void 0:P[L])||0)},0)),1),D=400,C=80,j=Math.min(40,(D-20)/f.length-4);E=`<svg width="${D}" height="${C+30}" style="overflow:visible">
      ${f.map(($,A)=>{const L=(EXAM_DEFS[$.type]||[]).reduce((N,G)=>{var te;return N+Number(((te=$.nets)==null?void 0:te[G])||0)},0),P=Math.max(Math.round(L/_*(C-10)),4),U=10+A*((D-20)/f.length);return`<rect x="${U}" y="${C-P}" width="${j}" height="${P}" rx="3" fill="${r}" opacity="0.85"/>
          <text x="${U+j/2}" y="${C-P-4}" text-anchor="middle" font-size="10" fill="#333">${L.toFixed(0)}</text>
          <text x="${U+j/2}" y="${C+14}" text-anchor="middle" font-size="9" fill="#666">${g($.name.replace("Deneme","").replace("TYT","").replace("AYT","").trim()||String(A+1))}</text>`}).join("")}
...
<div class="page">
  ...
  <div class="section">
    ...
    <table>
      <thead><tr><th>Sınav</th><th>Tarih</th><th>Tür</th>${(EXAM_DEFS[(M=f[0])==null?void 0:M.type]||[]).map(_=>`<th>${_}</th>`).join("")}<th>Toplam</th></tr></thead>
      <tbody>
        ${f.map(_=>{const D=EXAM_DEFS[_.type]||[],C=D.reduce((j,$)=>{var A;return j+Number(((A=_.nets)==null?void 0:A[$])||0)},0).toFixed(1);return`<tr>
            <td><strong>${g(_.name)}</strong></td>
            <td>${new Date(_.date+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"short"})}</td>
            <td>${g(_.type)}</td>
            ${D.map(j=>{var A;const $=Number(((A=_.nets)==null?void 0:A[j])||0);return`<td><span class="badge ${$>=20?"badge-green":$>=12?"badge-yellow":"badge-red"}">${$}</span></td>`}).join("")}
...
</html>`}function ds(){const e=document.getElementById("rpStuId").value,t=Zt(e,!0),n=window.open("","_blank","width=900,height=700");n.document.write(t),n.document.close()}function cs(){const e=document.getElementById("rpStuId").value;l.students.find(a=>a.id===e);const t=Zt(e,!1),n=window.open("","_blank");n.document.write(t),n.document.close(),setTimeout(()=>{n.focus(),n.print()},500),F("reportModal"),h('PDF oluşturuluyor — "PDF olarak kaydet" seçin')}async function ps(){const e=document.getElementById("rpStuId").value,t=l.students.find(s=>s.id===e);if(!t)return;const n=`${window.location.origin}/api/generate-pdf-report?studentId=${e}`,a=`Merhaba, ${t.name} isimli öğrencimizin bu dönemki performans ve gelişim raporu hazırlandı. Aşağıdaki bağlantıdan raporu detaylıca görüntüleyebilirsiniz:

🔗 ${n}`,o=`https://api.whatsapp.com/send?text=${encodeURIComponent(a)}`;window.open(o,"_blank"),F("reportModal"),h("WhatsApp yönlendirmesi açıldı ✓")}function ms(){let e=document.getElementById("weeklyPDFModal");e||(e=document.createElement("div"),e.id="weeklyPDFModal",e.className="modal-bg",e.innerHTML=`<div class="modal">
      ...
      <button class="btn btn-accent" style="width:100%;justify-content:center;padding:12px" onclick="generateWeeklyPDF()">PDF Oluştur →</button>
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pdfNote").value="",O("weeklyPDFModal")}function us(){const e=document.getElementById("pdfNote").value.trim();F("weeklyPDFModal"),na(l.activeStuId,e)}function na(e,t){var C,j;const n=l.students.find($=>$.id===e);if(!n)return;const a=(n==null?void 0:n.weekStart)??0,i=ee(l.weekOffset,a),o=V(i,6),s=((C=l.workspace)==null?void 0:C.brand_name)||"Rostrum Akademi",r=((j=l.workspace)==null?void 0:j.brand_color)||"#E8613A",d=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"],c=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],p={deneme:"#f59e0b",soru:"#3b82f6",konu:"#10b981",diger:"#8b5cf6"},m={deneme:"Deneme",soru:"Soru Bankası",konu:"Konu Anlatımı",diger:"Diğer"};let u=0,v=0,S=0;const I=[];for(let $=0;$<7;$++){const A=V(i,$),L=K(A),P=l.tasks[`${e}_${L}`]||[];u+=P.length,v+=P.filter(U=>U.done).length,S+=P.reduce((U,N)=>U+Number(N.duration||0),0),P.length>0&&I.push({d:A,ds:L,tasks:P,dayName:d[(a+$)%7]})}const f=u>0?Math.round(v/u*100):0,k=163.36,w=(k*(1-f/100)).toFixed(1),E=($,A=5)=>{let L="";for(let P=1;P<=A;P++)L+=`<span style="display:inline-block;width:6px;height:6px;border-radius:50%;margin-right:2px;background:${P<=$?r:"#E8E6DE"}"></span>`;return L},y=$=>$?'<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;border-radius:50%;background:#22C55E;flex-shrink:0"><svg width="8" height="6" viewBox="0 0 8 6"><path d="M1 3L3 5L7 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></span>':'<span style="display:inline-block;width:15px;height:15px;border-radius:50%;border:1.5px solid #D1D0DC;flex-shrink:0"></span>';let z="";for(const{d:$,tasks:A,dayName:L}of I){const P=A.reduce((N,G)=>N+Number(G.duration||0),0),U=A.map(N=>{const G=p[N.type]||"#94a3b8",te=m[N.type]||"Diğer",J=N.done,X=N.student_result||null,Z=N.student_feedback||null,R=X&&(X.dogru!=null||X.yanlis!=null||X.bos!=null)?`
        ...
        </div>`:"",H=N.student_note?`<div style="font-size:9px;color:#9998AA;font-style:italic;margin-top:4px;margin-left:21px;line-height:1.4">"${g(N.student_note)}"</div>`:"",Y=Z&&(Z.difficulty||Z.focus)?`
        ...
        <div style="flex:1;min-width:0">
          <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
            ${y(J)}
            <span style="font-size:11px;font-weight:800;color:${J?"#9998AA":"#111118"};${J?"text-decoration:line-through":""}">${g(N.subject)}</span>
            <span style="font-size:8px;font-weight:700;color:${G};text-transform:uppercase;letter-spacing:.5px;margin-left:2px">${te}${N.exam?" · "+g(N.exam):""}</span>
          </div>
          ${N.note?`<div style="font-size:9px;color:#6B6A7A;margin-left:21px;line-height:1.4;margin-bottom:2px">${g(N.note)}</div>`:""}
          ${R}
          ${H}
        </div>
      ...
      ${U}
    </div>`}const M=[{val:v,lbl:"Tamamlanan",col:"#22C55E"},{val:u-v,lbl:"Bekleyen",col:"#C4C3D0"},{val:Math.round(S/60)+" sa",lbl:"Toplam Süre",col:r},{val:u,lbl:"Toplam Görev",col:"#C4C3D0"}].map(($,A)=>`<div style="flex:1;${A>0?"border-left:1px solid rgba(255,255,255,.06);padding-left:16px;":""}padding-right:16px">
  ...
  <div class="page">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:8px;flex-shrink:0">
          <div style="position:relative;width:64px;height:64px">
            <svg width="64" height="64" viewBox="0 0 64 64" style="transform:rotate(-90deg)">
              ...
              <circle cx="32" cy="32" r="26" fill="none" stroke="${r}" stroke-width="5" stroke-linecap="round" stroke-dasharray="${k.toFixed(1)}" stroke-dashoffset="${w}"/>
            </svg>
  ...
  </body></html>`,D=window.open("","_blank","width=1000,height=850");D.document.write(_),D.document.close(),setTimeout(()=>D.focus(),300)}function gs(){const e="abcdefghijklmnopqrstuvwxyz",t=()=>Array.from({length:3},()=>e[Math.floor(Math.random()*e.length)]).join("");return`https://meet.google.com/${t()}-${t()}-${t()}`}function vs(){return`https://zoom.us/j/${Math.floor(Math.random()*9e9)+1e9}`}function fs(e){navigator.clipboard.writeText(e).then(()=>h("Link kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),h("Link kopyalandı ✓")})}const aa=[{name:"Altın",val:"#f0a500",dim:"rgba(240,165,0,.12)"},{name:"Turuncu",val:"#e8622a",dim:"rgba(232,98,42,.12)"},{name:"Mavi",val:"#4da6ff",dim:"rgba(77,166,255,.12)"},{name:"Yeşil",val:"#3ecf8e",dim:"rgba(62,207,142,.12)"},{name:"Mor",val:"#c084fc",dim:"rgba(192,132,252,.12)"},{name:"Pembe",val:"#f472b6",dim:"rgba(244,114,182,.12)"},{name:"Kırmızı",val:"#ff5c5c",dim:"rgba(255,92,92,.12)"},{name:"Turkuaz",val:"#06b6d4",dim:"rgba(6,182,212,.12)"}];function ia(){try{const e=JSON.parse(localStorage.getItem("ba_theme")||"{}");e.theme==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),e.accent&&oa(e.accent,e.accentDim,!1)}catch{}}function oa(e,t,n=!0){if(document.documentElement.style.setProperty("--accent",e),document.documentElement.style.setProperty("--accent-dim",t||"rgba(240,165,0,.12)"),n)try{const a=JSON.parse(localStorage.getItem("ba_theme")||"{}");a.accent=e,a.accentDim=t,localStorage.setItem("ba_theme",JSON.stringify(a))}catch{}}function ys(e){e==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{const t=JSON.parse(localStorage.getItem("ba_theme")||"{}");t.theme=e,localStorage.setItem("ba_theme",JSON.stringify(t))}catch{}document.querySelectorAll(".theme-btn").forEach(t=>{const n=t.dataset.theme===e;t.style.background=n?"var(--accent-dim)":"",t.style.borderColor=n?"var(--accent)":"",t.style.color=n?"var(--accent)":""})}function xs(){let e=document.getElementById("themePanel");if(e){e.remove();return}e=document.createElement("div"),e.id="themePanel";const t=document.documentElement.getAttribute("data-theme")!=="light";e.style.cssText="position:fixed;top:60px;right:12px;background:var(--surface);border:1px solid var(--border2);border-radius:14px;padding:18px;z-index:300;box-shadow:var(--shadow-lg);min-width:230px;animation:fadeUp .2s ease",e.innerHTML=`
    ...
    `)}function bs(){const e=document.getElementById("aiChatPanel"),t=document.getElementById("aiChatBubble");if(e.classList.contains("open"))e.classList.remove("open"),t.style.display="flex";else{e.classList.add("open"),t.style.display="none";const n=document.getElementById("aiMessages");n.scrollTop=n.scrollHeight,document.getElementById("aiInput").focus()}}function hs(e){document.getElementById("aiInput").value=e,ra()}function Bt(){var t;const e={};try{const n=l.students.find(s=>s.id===l.activeStuId);n&&(e.studentName=n.name,e.target=n.target||""),x.role==="parent"&&x.childName&&(e.studentName=x.childName);const a=(l.exams||[]).filter(s=>s.studentId===l.activeStuId).slice(-5);a.length&&(e.recentExams=a.map(s=>({name:s.type+" "+(s.name||""),date:s.date||"",nets:s.nets||{}})));let i=[];if(Object.entries(l.tasks||{}).forEach(([s,r])=>{s.startsWith(l.activeStuId+"_")&&(i=i.concat(r))}),i.length){const s=i.filter(r=>r.done).length;e.taskCompletionRate=Math.round(s/i.length*100),e.weeklyTaskCount=i.length}const o=Object.keys(EXAM_DEFS);a.length&&(e.examProfile=((t=a[0])==null?void 0:t.type)||o[0])}catch(n){console.warn("AI context error:",n)}return e}function ye(e,t){Ze.push({role:e,content:t});const n=document.getElementById("aiMessages"),a=n.querySelector(".ai-welcome");a&&a.remove();const i=new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),o=document.createElement("div");o.className=`ai-msg ${e}`,o.innerHTML=`${g(t).replace(/\n/g,"<br>")}<div class="ai-msg-time">${i}</div>`,n.appendChild(o),n.scrollTop=n.scrollHeight}let Jt=null;window._pickAiImg=function(e){const t=e.files[0];if(!t)return;if(t.size>8*1024*1024){h("Dosya max 8 MB olabilir"),e.value="";return}const n=new FileReader;n.onload=a=>{Jt={base64:a.target.result.split(",")[1],mimeType:t.type,name:t.name};const o=document.getElementById("aiImgPreview"),s=document.getElementById("aiImgThumb"),r=document.getElementById("aiImgName");s.src=a.target.result,s.style.display="block",r.textContent=t.name,o.style.display="flex"},n.readAsDataURL(t),e.value=""};window._cancelAiImg=function(){Jt=null;const e=document.getElementById("aiImgPreview");e&&(e.style.display="none")};async function ra(){if(Et)return;const e=document.getElementById("aiInput"),t=e.value.trim(),n=Jt;if(!(!t&&!n)){if(e.value="",n){window._cancelAiImg();const a=document.getElementById("aiMessages"),i=a.querySelector(".ai-welcome");i&&i.remove();const o=document.createElement("div");o.className="ai-msg user",o.innerHTML=`<img src="data:${n.mimeType};base64,${n.base64}" style="max-width:180px;max-height:180px;border-radius:10px;display:block" />${t?`<div style="margin-top:6px">${g(t)}</div>`:""}<div class="ai-msg-time">${new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}</div>`,a.appendChild(o),a.scrollTop=a.scrollHeight,Ze.push({role:"user",content:t||"Fotoğraftaki soruyu çöz.",image:n})}else ye("user",t);Et=!0,document.getElementById("aiTyping").classList.add("show"),document.getElementById("aiSendBtn").disabled=!0;try{const a=Bt(),i=x.role||"student";if(n){const o=await fetch("/api/ai-chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imageBase64:n.base64,mimeType:n.mimeType,text:t||"Bu soruyu çöz.",context:a,userRole:i})});if(o.ok){const s=await o.json();ye("assistant",s.reply||"Yanıt alınamadı.")}else{const s=await we(t,a,i,n);ye("assistant",s)}}else{const s=await fetch("/api/ai-chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:Ze.slice(-10),context:a,userRole:i})});if(s.ok){const r=await s.json();ye("assistant",r.reply||"Yanıt alınamadı.")}else{const r=await we(t,a,i,null);ye("assistant",r)}}}catch(a){console.error("AI error:",a);try{const i=Bt(),o=await we(t,i,x.role||"student",n);ye("assistant",o)}catch{const o=localStorage.getItem("gemini_api_key");ye("assistant","🔒 Bu özellik ileride aktif olacaktır. Yakında kullanıma açılacak.")}}finally{Et=!1,document.getElementById("aiTyping").classList.remove("show"),document.getElementById("aiSendBtn").disabled=!1}}}let _t=null;async function la(e){try{const t=await fetch(`https://generativelanguage.googleapis.com/v1beta/models?key=${e}`);if(!t.ok)return null;const a=(await t.json()).models||[];let i=a.find(o=>o.name.toLowerCase().includes("flash")&&o.supportedGenerationMethods.includes("generateContent"));if(i||(i=a.find(o=>o.supportedGenerationMethods.includes("generateContent"))),i)return i.name.replace("models/","")}catch(t){console.warn("Auto-detect model failed:",t)}return null}async function we(e,t,n,a){var S,I,f,k,w,E;let i=localStorage.getItem("gemini_api_key");if(!i)try{const{data:y}=await b.from("platform_settings").select("value").eq("key","ai_settings").maybeSingle();y&&y.value&&y.value.gemini_api_key&&(i=y.value.gemini_api_key)}catch(y){console.warn("DB Gemini API key load error:",y)}const o=i;if(!o)throw new Error("API anahtarı eksik.");let s="gemini-1.5-flash";if(o)if(_t)s=_t;else{const y=await la(o);y&&(_t=y,s=y,console.log("[Gemini API] Otomatik model tespiti başarılı:",s))}let r=`Sen "Rostrum Akademi Yapay Zeka Asistanı"sın. Türkiye eğitim sistemine (YKS, LGS) hakim, rolüne göre öğrencilere, velilere veya koçlara destek veren bir yapay zekasın.
...
Hedef: ${t.target}`);const p=Ze.slice(-8).map(y=>{const z=[];return y.image&&z.push({inlineData:{mimeType:y.image.mimeType,data:y.image.base64}}),z.push({text:y.content||(y.image?"Soruyu çöz":"")}),{role:y.role==="user"?"user":"model",parts:z}}),m=[{role:"user",parts:[{text:r}]},{role:"model",parts:[{text:"Anladım! Rostrum Akademi Yapay Zeka Asistanı olarak hazırım."}]},...p],u=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${s}:generateContent?key=${o}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:m,generationConfig:{temperature:.7,maxOutputTokens:1500}})});if(!u.ok){let y=`HTTP ${u.status}`;try{const z=await u.json();(S=z==null?void 0:z.error)!=null&&S.message&&(y=z.error.message)}catch{}throw new Error(y)}const v=await u.json();return((E=(w=(k=(f=(I=v==null?void 0:v.candidates)==null?void 0:I[0])==null?void 0:f.content)==null?void 0:k.parts)==null?void 0:w[0])==null?void 0:E.text)||"Yanıt üretilemedi."}let Xt="";async function ks(e){const t=l.students.find(a=>a.id===e);if(!t)return;const n=document.getElementById("aiCopilotBtn");n.disabled=!0,n.textContent="⌛ Analiz Ediliyor ve Taslak Oluşturuluyor...";try{const a=ee(0,t.weekStart||0);let i=0,o=0,s=0;for(let w=0;w<7;w++){const E=l.tasks[`${t.id}_${K(V(a,w))}`]||[];i+=E.length,o+=E.filter(y=>y.done).length,s+=E.reduce((y,z)=>y+Number(z.duration||0),0)}const r=i>0?Math.round(o/i*100):0,c=(l.exams||[]).filter(w=>w.studentId===e).slice(-5).map(w=>({name:w.type+" "+(w.name||""),date:w.date||"",nets:w.nets||{}})),p={};(l.studentSpeeds||[]).filter(w=>w.student_id===e).forEach(w=>{p[`${w.exam_type}_${w.subject}`]=w.secs_per_question});const m=`Lütfen şu öğrenci için haftalık durum analizi ve öğrenciye gönderilecek haftalık değerlendirme mesajı taslağı oluştur:
Öğrenci Adı: ${t.name}
...
[TASLAK]
(Öğrenciye gönderilecek haftalık değerlendirme taslağı)`;let u="";const v={studentName:t.name,target:t.target,recentExams:c,taskCompletionRate:r,weeklyTaskCount:i};try{const w=await fetch("/api/ai-chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:[{role:"user",content:m}],context:v,userRole:"coach"})});w.ok?u=(await w.json()).reply:u=await we(m,v,"coach")}catch{u=await we(m,v,"coach")}let S="Analiz üretilemedi.",I="Taslak üretilemedi.";const f=u.indexOf("[ANALİZ]"),k=u.indexOf("[TASLAK]");f!==-1&&k!==-1?f<k?(S=u.substring(f+8,k).trim(),I=u.substring(k+8).trim()):(I=u.substring(k+8,f).trim(),S=u.substring(f+8).trim()):I=u,document.getElementById("aiCopilotAnalysisBox").innerHTML=`<b>📊 Yapay Zeka Durum Analizi:</b><br>${S.replace(/\n/g,"<br>")}`,document.getElementById("aiCopilotTextarea").value=I,Xt=I,document.getElementById("aiCopilotResultArea").style.display="block",document.getElementById("aiCopilotSendBtn").disabled=!0,document.getElementById("aiCopilotEditWarning").style.display="inline"}catch(a){console.error("generateAICopilotDraft error:",a),h("Taslak oluşturulurken hata: "+a.message)}finally{n.disabled=!1,n.textContent="🤖 Durum Analizi Yap ve Taslak Oluştur"}}function ws(){const e=document.getElementById("aiCopilotTextarea").value.trim(),t=document.getElementById("aiCopilotSendBtn"),n=document.getElementById("aiCopilotEditWarning");e&&e!==Xt?(t.disabled=!1,n.style.display="none"):(t.disabled=!0,n.style.display="inline")}async function $s(e){var a;const t=document.getElementById("aiCopilotTextarea").value.trim();if(!t)return;const n=document.getElementById("aiCopilotSendBtn");n.disabled=!0,n.textContent="Gönderiliyor...";try{const i=x.coachId||((a=l.students.find(r=>r.id===e))==null?void 0:a.coachId),{data:o,error:s}=await b.from("messages").insert({student_id:e,coach_id:i,from_role:"coach",text:t,read:!1}).select().single();if(s)throw s;await b.from("reports").insert({student_id:e,coach_id:i,type:"ai_copilot",title:"Yapay Zeka Copilot Değerlendirmesi",content:t,start_date:ve(),end_date:ve()}),l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:o.id,from:"coach",text:t,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),h("Taslak mesaj başarıyla düzenlendi, öğrenciye gönderildi ve arşive kaydedildi! ✓"),document.getElementById("aiCopilotResultArea").style.display="none",document.getElementById("aiCopilotTextarea").value="",Xt=""}catch(i){console.error("sendCopilotDraft error:",i),h("Gönderim hatası: "+i.message),n.disabled=!1}finally{n.textContent="✍️ Düzenlemeyi Kaydet ve Öğrenciye Gönder"}}function da(){const e=l.students.find(r=>r.id===l.activeStuId),t=x.childName||(e==null?void 0:e.name)||"Öğrenci",n=document.getElementById("view-parent-home");if(!n)return;let a=[];Object.entries(l.tasks||{}).forEach(([r,d])=>{r.startsWith(l.activeStuId+"_")&&(a=a.concat(d))});const i=a.filter(r=>r.done).length,o=a.length?Math.round(i/a.length*100):0,s=(l.exams||[]).filter(r=>r.studentId===l.activeStuId).slice(-3);n.innerHTML=`
    ...
    </div>`}function ca(){const e=document.getElementById("view-parent-progress");if(!e)return;const t=l.students.find(o=>o.id===l.activeStuId),n=x.childName||(t==null?void 0:t.name)||"Öğrenci",a=(l.exams||[]).filter(o=>o.studentId===l.activeStuId);let i=[];Object.entries(l.tasks||{}).forEach(([o,s])=>{o.startsWith(l.activeStuId+"_")&&(i=i.concat(s))}),e.innerHTML=`
    <div style="padding:24px;max-width:800px;margin:0 auto">
      ...
      <div class="card" style="padding:20px;margin-bottom:16px">
        ...
        ${i.length?i.slice(-10).map(o=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1;font-size:13px">${g(o.subject)} <span style="font-size:11px;color:var(--text-dim)">(${Xe(o.type)})</span></div>
    ...
    </div>`}function pa(){const e=document.getElementById("view-parent-ai");e&&(e.innerHTML=`
    <div style="padding:24px;max-width:600px;margin:0 auto;text-align:center">
      ...
      <div style="margin-bottom:28px">
        ...
        ${Object.entries(m).map(([u,v])=>{const S=i[u]||"#6B7280",I=o[u]||"📌";return`<div>
      ...
      <div class="analytics-grid">
        ${ma(t).map(d=>{const c=d.totalCount>0?Math.round(d.doneCount/d.totalCount*100):0,p=c>=80?"var(--green)":c>=50?"var(--accent)":"var(--text-dim)";return`<div class="analytics-card">
...
`)}}):(document.getElementById("crmExam").value="TYT",document.getElementById("crmSubject").value="Matematik",document.getElementById("crmPublisher").value="",document.getElementById("crmName").value="",document.getElementById("crmTests").value=""),O("coachResourceModal")}async function Is(){const e=document.getElementById("crmYtUrl").value.trim(),t=document.getElementById("crmYtStatus");if(!e)return t.innerHTML='<span style="color:var(--red)">⚠️ Playlist URL girin</span>';const n=e.match(/[?&]list=([^&]+)/);if(!n)return t.innerHTML='<span style="color:var(--red)">⚠️ list= parametresi bulunamadı</span>';const a=n[1];t.innerHTML="⏳ Çekiliyor...";try{let i=[],o="";do{let r=`/api/youtube?playlistId=${a}`;o&&(r+=`&pageToken=${o}`);const d=await fetch(r);if(!d.ok)throw new Error("Playlist çekilemedi.");const c=await d.json();c.items&&(i=i.concat(c.items)),o=c.nextPageToken||"",t.innerHTML=`⏳ ${i.length} video yükleniyor...`}while(o&&i.length<200);window._crmFetchedVideos=i;const s=document.getElementById("crmVideoPreview");if(s.style.display="",s.innerHTML=i.map((r,d)=>`
      ...
      </div>`).join(""),i.length>0&&!document.getElementById("crmName").value){const r=i[0].title;document.getElementById("crmName").value=r.split(" | ")[0].split(" - ")[0].trim().slice(0,50)}t.innerHTML=`<span style="color:var(--green)">✓ ${i.length} video çekildi!</span>`}catch(i){t.innerHTML=`<span style="color:var(--red)">⚠️ Hata: ${i.message}</span>`}}async function zs(){const e=document.getElementById("crmName").value.trim(),t=document.getElementById("crmSubject").value;if(!e||!t)return h("Ad ve ders zorunlu!");const n=document.getElementById("crmId").value,a=document.getElementById("crmType").value==="playlist",i=document.getElementById("crmTests").value.split(`
`).map(d=>d.trim()).filter(Boolean),o=window._crmFetchedVideos||[];let s=[];if(a){if(o.length>0?s=o.map(d=>({label:d.title||"",url:d.url||"",topic:"",soru:parseInt(d.duration)||0})):s=i.map(d=>{const c=d.split("|").map(p=>p.trim());return{label:c[0]||"",url:c[1]||"",topic:"",soru:parseInt(c[2])||0}}),!s.length)return h("Video listesi boş! Önce playlist çekin.")}else s=i.map(d=>{const c=d.split("|").map(p=>p.trim());return{label:c[0]||"",soru:parseInt(c[1])||0}});const r={exam_type:document.getElementById("crmExam").value,subject:t,publisher:document.getElementById("crmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:s,active:!0,resource_type:a?"playlist":"book",coach_id:x.coachId};B(!0),n?(await b.from("resources").update(r).eq("id",n),h("Güncellendi ✓")):(await b.from("resources").insert(r),h("Kaynak eklendi ✓")),B(!1),F("coachResourceModal"),$e=[],it()}async function Bs(e){await ae("Bu kaynağı silmek istediğinizden emin misiniz?")&&(B(!0),await b.from("resources").delete().eq("id",e),B(!1),h("Silindi"),$e=[],it())}function Ms(e){const t=e.target.files[0];if(!t)return;B(!0);const n=new FileReader;n.onload=async a=>{try{const i=new Uint8Array(a.target.result),o=XLSX.read(i,{type:"array"}),s=o.SheetNames[0],r=o.Sheets[s],d=XLSX.utils.sheet_to_json(r);if(d.length===0)return B(!1),h("Excel dosyası boş!");const c={};d.forEach(u=>{const v=u["Kaynak Adı"]||u.Name||u["Kitap Adı"]||u["Playlist Adı"]||"",I=(u["Kaynak Türü"]||u.Type||u.Tür||"book").toLowerCase().includes("playlist")?"playlist":"book",f=u.Yayınevi||u.Publisher||u.Hoca||"",k=u.Sınav||u.Exam||"TYT",w=u.Ders||u.Subject||"",E=u["Öğe Adı"]||u.Test||u.Video||u["Test Adı"]||u["Video Adı"]||"",y=parseInt(u["Soru Sayısı"]||u.Soru||u.Süre||u["Süre (dk)"]||0),z=u.URL||u.Link||"";if(!v||!w||!E)return;const T=`${v}_${k}_${w}_${I}`;c[T]||(c[T]={exam_type:k,subject:w,publisher:f,name:v,resource_type:I,tests:[]}),c[T].tests.push({label:E,soru:y,url:z,topic:""})});const p=Object.values(c);if(p.length===0)return B(!1),h("Uyumlu veri bulunamadı! Sütun başlıklarını kontrol edin.");let m=0;for(const u of p){const{error:v}=await b.from("resources").insert({...u,year:new Date().getFullYear(),active:!0,coach_id:x.coachId});v||m++}B(!1),h(`✓ Excel'den ${m} kaynak başarıyla aktarıldı!`),$e=[],it()}catch(i){B(!1),console.error(i),h("Excel okuma hatası: "+i.message)}},n.readAsArrayBuffer(t)}function As(e){const t=e.target.files[0];if(!t)return;B(!0);const n=new FileReader;n.onload=async a=>{try{const i=new Uint8Array(a.target.result),o=XLSX.read(i,{type:"array"}),s=o.Sheets[o.SheetNames[0]],r=XLSX.utils.sheet_to_json(s);if(r.length===0)return B(!1),h("Excel dosyası boş!");let d=0;for(const c of r){const p=c["Ad Soyad"]||c.Ad||c.Name||"",m=c.Hedef||c.Target||"Hedef belirtilmemiş";let u=c["Kullanıcı Adı"]||c.Username||"",v=c.Şifre||c.Password||STU_DEFAULT_PASS;if(!p)continue;u||(u=p.toLowerCase().replace(/\s+/g,"")+Math.floor(Math.random()*100),u=Ae(u));const S=await Le(v),I=u+"@rostrumakademi.com",{data:f,error:k}=await b.rpc("create_new_user",{p_email:I,p_password:v,p_full_name:p,p_username:u,p_role:"student",p_target:m,p_color:"#4da6ff",p_progress:0,p_week_start:0,p_coach_id:x.coachId,p_institution_id:null,p_exam_profile:"YKS"});!k&&f&&(l.students.push({id:f,name:p,target:m,color:"#4da6ff",progress:0,pass:S,weekStart:0,username:u}),d++)}B(!1),h(`✓ Excel'den ${d} öğrenci başarıyla eklendi!`),be(),Qe()}catch(i){B(!1),console.error(i),h("Excel okuma hatası: "+i.message)}},n.readAsArrayBuffer(t)}function ua(e){if(!l.activeStuId||!q)return null;let t=null;return Object.entries(l.tasks).forEach(([n,a])=>{n.startsWith(l.activeStuId+"_")&&a.forEach(i=>{i.subject&&i.subject.includes(q.name)&&(i.task_items&&Array.isArray(i.task_items)?i.task_items.forEach(o=>{(o.label||o)===e&&(o.done||i.done?t="done":t!=="done"&&(t="pending"))}):i.note&&i.note.includes(e)&&(i.done?t="done":t!=="done"&&(t="pending")))})}),t}async function Ds(e,t){var d;const a=`${l.activeStuId}_${e}`,i=(d=l.tasks[a])==null?void 0:d[t];if(!i)return;ze=e,_editingTaskId=i._id,q=null,document.querySelector("#taskModal h2").innerHTML=`Görev Düzenle — <span id="tmDay">${e}</span>`,document.querySelector("#taskModal .btn-accent").textContent="Güncelle",document.getElementById("tmType").value=i.type,document.getElementById("tmExam").value=i.exam||"",document.getElementById("tmDuration").value=i.duration||60,document.getElementById("tmStartTime").value=i.start_time||"",document.getElementById("tmNote").value=i.note||"";const o=i.exam||"",s=i.type;{const c=document.getElementById("tmSubjectSel"),p=document.getElementById("tmSubjectFree");document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none";const m=document.getElementById("tmTestSummary");m&&(m.style.display="none"),o&&typeof SUBJECT_MAP<"u"&&SUBJECT_MAP[o]?(c.innerHTML=SUBJECT_MAP[o].map(S=>`<option value="${S}">${S}</option>`).join(""),c.style.display="",p.style.display="none"):(c.style.display="none",p.style.display="");const u=(s==="soru"||s==="konu")&&o;document.getElementById("soruBankasiWrap").style.display=u?"":"none";const v=document.getElementById("tmBookSearch");v&&(v.placeholder=s==="konu"?"Hoca veya playlist ara...":"Kitap veya yayınevi ara...")}if((s==="soru"||s==="konu")&&o){const c=document.getElementById("tmSubjectSel");let p="",m=i.subject;if(i.subject.includes(" - ")){const I=i.subject.split(" - ");p=I[0].trim(),m=I.slice(1).join(" - ").trim()}p&&SUBJECT_MAP[o]&&SUBJECT_MAP[o].includes(p)&&(c.value=p),document.getElementById("tmBookVal").value=m,document.getElementById("tmBookSearch").value=m,B(!0),await In(),B(!1);const u=`${o}_${p}`;let S=(se[u]||[]).find(I=>I.name===m);if(S||Object.values(se).forEach(I=>{const f=I.find(k=>k.name===m);f&&(S=f)}),S){q=S,document.getElementById("tmTestWrap").style.display="",Ht();const I=(i.task_items||[]).map(k=>k.label||k);document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(k=>{var y;const w=parseInt(k.value),E=((y=q.testler[w])==null?void 0:y.label)||q.testler[w];I.includes(E)?k.checked=!0:k.checked=!1}),Ke()}}else{const c=document.getElementById("tmSubjectSel"),p=document.getElementById("tmSubjectFree");c.style.display!=="none"?c.value=i.subject:p.value=i.subject,document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none"}O("taskModal")}async function Cs(){const e=prompt("Şablon adı giriniz:");if(!e)return;const t=l.students.find(r=>r.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=ee(l.weekOffset,n),i=[];for(let r=0;r<7;r++){const d=V(a,r),c=K(d),p=`${l.activeStuId}_${c}`;(l.tasks[p]||[]).forEach(u=>{i.push({day_index:r,type:u.type,exam_type:u.exam||null,subject:u.subject,duration:u.duration,note:u.note||"",task_items:u.task_items||null})})}if(i.length===0)return h("Bu haftada kaydedilecek görev bulunmuyor!");B(!0);const{error:o}=await b.from("program_templates").insert({coach_id:x.coachId,name:e,description:`${i.length} görev içeriyor.`,tasks:i});if(B(!1),o)return h("Şablon kaydedilemedi: "+o.message);h("Hafta şablon olarak kaydedildi ✓"),await ae(`"${e}" şablonunu Rostrum Akademi ekibiyle paylaşmak ister misiniz?

Paylaşılan şablonlar değerlendirilerek tüm koçlara önerilebilir.`)&&b.auth.getSession().then(({data:{session:r}})=>{const d=r==null?void 0:r.access_token;d&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({type:"template_share",template_name:e,task_count:i.length,tasks_json:JSON.stringify(i,null,2)})}).then(()=>h("Şablon Rostrum ekibiyle paylaşıldı ✓")).catch(()=>h("Şablon kaydedildi, paylaşım gönderilemedi."))})}async function Ls(){B(!0);const{data:e,error:t}=await b.from("program_templates").select("*").eq("coach_id",x.coachId);if(B(!1),t)return h("Şablonlar yüklenemedi.");if(!e||e.length===0)return h("Kayıtlı şablonunuz bulunmuyor. Önce haftayı şablon olarak kaydedin.");let n=document.getElementById("applyTemplateModal");n||(n=document.createElement("div"),n.id="applyTemplateModal",n.className="modal-bg",n.innerHTML=`<div class="modal">
    ...
    </div>`).join("");const s=t.filter(d=>d.status==="pending").length,r=document.getElementById("sbi_coach-applications");if(r){const d=r.querySelector(".sb-badge");if(d&&d.remove(),s>0){const c=document.createElement("span");c.className="sb-badge",c.textContent=s,r.appendChild(c)}}}async function Ys(e,t,n,a){var o;const{error:i}=await b.from("match_requests").update({status:t}).eq("id",e);if(i)return h("Hata: "+i.message);h(t==="accepted"?"✓ Başvuru kabul edildi":"Başvuru reddedildi"),n&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"application_update",to:n,student_name:a||"",status:t,coach_name:((o=l.workspace)==null?void 0:o.brand_name)||"Koçunuz"})}).catch(s=>console.warn("[updateApplication] mail error:",s.message)),en()}let Ce=null;async function ga(){var a;const e=document.getElementById("view-coach-notes");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:860px;margin:0 auto">
  ...
  </div>`;const t=`coach_notes_${x.coachId}`,{data:n}=await b.from("platform_settings").select("value").eq("key",t).maybeSingle();Ce=((a=n==null?void 0:n.value)==null?void 0:a.notes)||[],tn()}function tn(){const e=document.getElementById("coachNotesList");if(!e)return;const t=Ce;if(!t.length){e.innerHTML=`<div style="grid-column:1/-1;text-align:center;padding:48px;color:var(--text-dim)">
      <div style="font-size:36px;margin-bottom:12px">📝</div>
    ...
    </div>`).join("")}function Ks(e){const t=e!==null?Ce[e]||{}:{};let n=document.getElementById("coachNoteModal");n||(n=document.createElement("div"),n.id="coachNoteModal",n.className="modal-bg",document.body.appendChild(n)),n.innerHTML=`<div class="modal" style="max-width:520px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
  ...
  </div>`,n.style.display="flex"}async function Os(e){const t=document.getElementById("noteEditorTitle").value.trim(),n=document.getElementById("noteEditorBody").value.trim();if(!t&&!n)return h("Not boş olamaz");const a={title:t||"Başlıksız",body:n,updated:new Date().toISOString()};e===null?Ce.unshift(a):Ce[e]=a,await va(),document.getElementById("coachNoteModal").style.display="none",tn(),h("Not kaydedildi ✓")}async function Fs(e){await ae("Bu notu silmek istiyor musun?")&&(Ce.splice(e,1),await va(),tn(),h("Not silindi"))}async function va(){const e=`coach_notes_${x.coachId}`;await b.from("platform_settings").upsert({key:e,value:{notes:Ce}},{onConflict:"key"})}window.toggleSidebar=Ha;window.setupShell=Ya;window.switchTab=ie;window.renderHome=hn;window.renderCoachApplications=en;window.updateApplication=Ys;window.renderCoachNotes=ga;window.openNoteEditor=Ks;window.toggleNewResourceMode=pi;window.addManualTest=mi;window.removeManualTest=ui;window.saveCoachNote=Os;window.deleteCoachNote=Fs;window.renderStudentsSearch=Qe;window.filterStudentSearch=Ka;window.openStudentDetail=kn;window.openKonuHaritasi=Ua;window.openStudentProgram=jt;window.openStudentExams=Ga;window.openStudentAppointments=qa;window.renderProfile=Tn;window.saveProfile=Qa;window.renderSettings=En;window.saveGeminiKey=ei;window.renderProgram=W;window.selectStu=ti;window.chWeek=ni;window.goToday=ai;window.openClearWeekModal=oi;window.toggleDaySel=si;window.toggleAllDays=ri;window.confirmClearDays=li;window.openTaskModal=gi;window.loadResources=In;window.updateSubjectList=Rt;window.updateBookList=vi;window.renderBookList=ft;window.filterBooks=fi;window.selectBook=yi;window.renderTestList=Ht;window.selectAllTests=xi;window.clearAllTests=bi;window.updateTestSummary=Ke;window.selectModalSpeed=hi;window.applyDuration=ki;window.loadStudentSpeeds=zn;window.saveStudentSpeed=Bn;window.saveTask=wi;window.toggleTask=$i;window.closeTaskMenu=Nt;window.showTaskMenu=Ti;window.copyTask=Ei;window.deleteTask=_i;window.renderTodoList=Cn;window.renderStudents=jn;window.goProgram=Pi;window.openStudentModal=Ri;window.saveStudent=Hi;window.showInviteInfo=Pn;window.copyInvite=Yi;window.deleteStu=Ki;window.renderAppointments=et;window.renderCalDays=yt;window.selCalDay=Oi;window.chCalMonth=Fi;window.renderApptList=Yt;window.openApptModal=Ui;window.saveAppt=Gi;window.deleteAppt=qi;window.renderExams=Oe;window.openCommentModal=Qi;window.saveComment=eo;window.deleteExam=to;window.renderMessages=On;window.selectThread=no;window.renderThreadHTML=Te;window.sendMsg=ao;window.scrollMsgs=Ee;window.renderPortal=xt;window.stuToggleTask=io;window.renderSPortal=_e;window.stuToggleTask2=oo;window.chWeekS=so;window.openTaskDetail=Kt;window.toggleTaskDetail=co;window.toggleDetailItem=po;window.selectVideoSpeed=mo;window.saveTaskDetail=uo;window.renderSExams=Ot;window.openStudentExamModal=Fn;window.openExamModal=go;window.renderNetInputs=Ft;window.saveExam=yo;window.renderSMessages=It;window.initRealtime=Ut;window.destroyRealtime=Gt;window.renderDevDashboard=Gn;window.renderDevUsers=tt;window.openDevUserModal=bo;window.devDeleteUser=ho;window.openPlanModal=ko;window.savePlan=wo;window.renderDevResources=nt;window.openPlaylistModal=$o;window.fetchYouTubePlaylist=To;window.savePlaylist=Eo;window.openResourceModal=_o;window.saveResource=So;window.devDeleteResource=Io;window.renderDevFinance=bt;window.openPaymentModal=zo;window.savePayment=Bo;window.openSubModal=Mo;window.saveSub=Ao;window.renderDevAnnounce=at;window.openAnnounceModal=Do;window.saveAnnounce=Co;window.toggleAnnounce=Lo;window.devDeleteAnnounce=jo;window.renderDevTickets=Fe;window.updateTicketStatus=Yo;window.devDeleteTicket=Ko;window.selectDevTicket=Po;window.sendDevReply=No;window.openSupportTicket=Oo;window.openSupportChat=ht;window.closeSupportChat=qn;window.startAISupportChat=Fo;window.startEminSupportChat=Uo;window.submitEminInitialMessage=Go;window.sendSupportMessage=qo;window.openSupportChatDirect=ht;window.checkCoachSubscription=Lt;window.showTrialExpiredScreen=ct;window.loadAnnouncements=Wn;window.saveStudentDev=Ts;window.showOnboarding=Jn;window.showOnboardingWidget=Zo;window.showStudentWelcome=Jo;window.renderSProfil=Qn;window.saveStudentProfile=Xo;window.changePassword=Qo;window.renderCoachProfile=ea;window.updateProfilePreview=qt;window.switchPreviewTab=ts;window.nl2br=ta;window.saveCoachProfile=ns;window.renderDevMatches=Wt;window.updateMatchRequestStatus=as;window.openSpeedModal=is;window.saveAllSpeeds=os;window.openStudentNotes=ss;window.saveStudentNote=rs;window.openReportModal=ls;window.getReportDates=Vt;window.buildReportHTML=Zt;window.previewReport=ds;window.generatePDF=cs;window.openWeeklyPDFModal=ms;window.generateWeeklyPDF=us;window.printWeeklyProgramWithNote=na;window.generateMeetLink=gs;window.generateZoomLink=vs;window.copyToClipboard=fs;window.loadTheme=ia;window.applyAccent=oa;window.setTheme=ys;window.openThemePanel=xs;window.initAIChatForRole=sa;window.toggleAIChat=bs;window.aiQuickSend=hs;window.buildAIContext=Bt;window.addAIMessage=ye;window.sendAIMessage=ra;window.autoDetectModel=la;window.callGeminiFallback=we;window.generateAICopilotDraft=ks;window.checkCopilotDraftEdited=ws;window.sendCopilotDraft=$s;window.renderParentHome=da;window.renderParentProgress=ca;window.renderParentAI=pa;window.applyResFilter=Qt;window.updateCRFilter=Es;window.buildCRContent=kt;window.renderCoachResources=it;window.switchCRTab=_s;window.compileResourceStats=ma;window.openResourceModalCoach=Ss;window.fetchYtPlaylistCoach=Is;window.saveResourceCoach=zs;window.deleteResourceCoach=Bs;window.importResourcesFromExcel=Ms;window.importStudentsFromExcel=As;window.getTestStatus=ua;window.openCoachTaskEdit=Ds;window.saveWeekAsTemplate=Cs;window.applyTemplateToWeek=Ls;window.downloadICS=Wi;window.confirmApplyTemplate=js;window.copyTaskToClipboard=Ps;window.pasteTaskFromClipboard=Rs;window.copyTaskToWholeWeek=Hs;window.pasteTaskToWholeWeek=Ns;window.sendWhatsAppReport=ps;window.toggleUserMenu=Na;window.closeUserMenu=bn;window.renderAgenda=he;window.openAgendaApptModal=Ln;window.deleteAgendaAppt=ji;window.agendaPrev=Bi;window.agendaNext=Mi;window.agendaToday=Ai;window.agendaSetFilter=Di;window.exportAgendaICS=Ci;window.openApptPopup=Dn;window.handleApptDrop=Li;window.openStudentKaynaklar=Wa;window.addStudentBook=Va;window.editStudentBook=Za;window.sbUpdatePct=$n;window.saveStudentBook=Ja;window.deleteStudentBook=Xa;async function Us(){const e=document.getElementById("rpStuId").value,t=l.students.find(m=>m.id===e);if(!t)return;const n=document.getElementById("rpPeriod").value,{start:a,end:i}=Vt(),o=document.getElementById("rpNote").value.trim();let s="Performans Raporu";n==="weekly"?s="Haftalık Performans Raporu":n==="monthly"?s="Aylık Performans Raporu":s="Özel Dönem Performans Raporu";const r=`${s} (${a} - ${i})`,d=o||"Değerlendirme notu eklenmedi.";B(!0);const c=x.coachId||t.coachId,{error:p}=await b.from("reports").insert({student_id:e,coach_id:c,type:"performance",title:r,content:d,start_date:a,end_date:i});B(!1),p?h("Rapor kaydedilirken hata oluştu: "+p.message):(h("Rapor başarıyla geçmişe kaydedildi! ✓"),F("reportModal"))}async function fa(e){const t=l.students.find(s=>s.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&ie("student-detail");const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${g(t.name)}</button>
  ...
  `,O("viewReportDetailModal")}function qs(){const e=document.getElementById("viewReportDetailModal");if(!e)return;const t=e.querySelector("h3").textContent,n=e.querySelector("div div").textContent,a=e.querySelector('div[style*="pre-wrap"]').textContent,i=window.open("","_blank");i.document.write(`
    <html>
      <head>
        <title>${t}</title>
        <style>
